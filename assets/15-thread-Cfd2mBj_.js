import{i as e,r as t,s as n,t as r}from"./app-Bmf6MlmU.js";var i=JSON.parse(`{"path":"/python-tutor/basics/15-thread.html","title":"多线程编程","lang":"zh-CN","frontmatter":{"order":15,"description":"多线程编程 其实创建线程之后，线程并不是始终保持一个状态的，其状态大概如下： New 创建 Runnable 就绪。等待调度 Running 运行 Blocked 阻塞。阻塞可能在 Wait Locked Sleeping Dead 消亡 线程有着不同的状态，也有不同的类型。大致可分为： 主线程 子线程 守护线程（后台线程） 前台线程 简单了解完这些之...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"多线程编程\\",\\"image\\":[\\"http://twowaterimage.oss-cn-beijing.aliyuncs.com/2019-10-14-Condition.png\\"],\\"dateModified\\":\\"2026-07-16T05:29:15.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yzqdev\\",\\"url\\":\\"http://www.yzqdev.top\\"}]}"],["meta",{"property":"og:url","content":"https://yzqdev.github.io/cs-guide/cs-guide/python-tutor/basics/15-thread.html"}],["meta",{"property":"og:site_name","content":"cs-guide"}],["meta",{"property":"og:title","content":"多线程编程"}],["meta",{"property":"og:description","content":"多线程编程 其实创建线程之后，线程并不是始终保持一个状态的，其状态大概如下： New 创建 Runnable 就绪。等待调度 Running 运行 Blocked 阻塞。阻塞可能在 Wait Locked Sleeping Dead 消亡 线程有着不同的状态，也有不同的类型。大致可分为： 主线程 子线程 守护线程（后台线程） 前台线程 简单了解完这些之..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"http://twowaterimage.oss-cn-beijing.aliyuncs.com/2019-10-14-Condition.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-07-16T05:29:15.000Z"}],["meta",{"property":"article:modified_time","content":"2026-07-16T05:29:15.000Z"}]]},"git":{"createdTime":1653497324000,"updatedTime":1784179755000,"contributors":[{"name":"yzqdev","username":"yzqdev","email":"yzqdev@outlook.com","commits":5,"url":"https://github.com/yzqdev"}]},"readingTime":{"minutes":7.54,"words":2261},"filePathRelative":"python-tutor/basics/15-thread.md","autoDesc":true}`),a={name:`15-thread.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="多线程编程" tabindex="-1"><a class="header-anchor" href="#多线程编程"><span>多线程编程</span></a></h1><p>其实创建线程之后，线程并不是始终保持一个状态的，其状态大概如下：</p><ul><li>New 创建</li><li>Runnable 就绪。等待调度</li><li>Running 运行</li><li>Blocked 阻塞。阻塞可能在 Wait Locked Sleeping</li><li>Dead 消亡</li></ul><p>线程有着不同的状态，也有不同的类型。大致可分为：</p><ul><li>主线程</li><li>子线程</li><li>守护线程（后台线程）</li><li>前台线程</li></ul><p>简单了解完这些之后，我们开始看看具体的代码使用了。</p><h2 id="_1、线程的创建" tabindex="-1"><a class="header-anchor" href="#_1、线程的创建"><span>1、线程的创建</span></a></h2><p>Python 提供两个模块进行多线程的操作，分别是 <code>thread</code> 和 <code>threading</code></p><p>前者是比较低级的模块，用于更底层的操作，一般应用级别的开发不常用。</p><p>因此，我们使用 <code>threading</code> 来举个例子：</p><div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python3</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意，不同的环境输出的结果肯定是不一样的。</p><h2 id="_2、线程合并-join方法" tabindex="-1"><a class="header-anchor" href="#_2、线程合并-join方法"><span>2、线程合并（join方法）</span></a></h2><p>上面的示例打印出来的结果来看，主线程结束后，子线程还在运行。那么需要主线程等待子线程运行完后，再退出，要怎么办呢？这时候，就需要用到 <code>join</code> 方法了。</p><p>在上面的例子，新增一段代码，具体如下：</p><div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python3</span></span>
<span class="line"><span class="token comment"># -*- coding: UTF-8 -*-</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> time</span>
<span class="line"><span class="token keyword">import</span> threading</span>
...
<span class="line"></span></code></pre></div><h2 id="_6、后台线程" tabindex="-1"><a class="header-anchor" href="#_6、后台线程"><span>6、后台线程</span></a></h2><p>默认情况下，主线程退出之后，即使子线程没有 join。那么主线程结束后，子线程也依然会继续执行。如果希望主线程退出后，其子线程也退出而不再执行，则需要设置子线程为后台线程。Python 提供了 <code>setDeamon</code> 方法。</p>`,62)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};