import{_ as e,c as s,a as l,o as a}from"./app-Dd1lYWPM.js";const i={};function c(t,n){return a(),s("div",null,n[0]||(n[0]=[l(`<h1 id="confluence-安装和配置" tabindex="-1"><a class="header-anchor" href="#confluence-安装和配置"><span>Confluence 安装和配置</span></a></h1><h2 id="confluence-6-15-4" tabindex="-1"><a class="header-anchor" href="#confluence-6-15-4"><span>Confluence 6.15.4</span></a></h2><ul><li>最新 6.15.4 版本时间：2019-05</li></ul><h4 id="数据库" tabindex="-1"><a class="header-anchor" href="#数据库"><span>数据库</span></a></h4><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">docker run \\</span>
