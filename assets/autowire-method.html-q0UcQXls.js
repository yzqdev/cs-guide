...
</code></pre><p>这种注入方式应该是笔者目前为止开发中见到的最常见的注入方式。原因很简单：</p><ol><li><p>注入方式非常简单：加入要注入的字段，附上<code>@Autowired</code>，即可完成。</p></li><li><p>使得整体代码简洁明了，看起来美观大方。</p></li></ol><h3 id="_2-2-构造器注入" tabindex="-1"><a class="header-anchor" href="#_2-2-构造器注入"><span>2.2 构造器注入</span></a></h3><pre><code class="language-java">@Controller
public class FooController {
...
</code></pre><p>在Spring4.x版本中推荐的注入方式就是这种，相较于上面的field注入方式而言，就显得有点难看，特别是当注入的依赖很多（5个以上）的时候，就会明显的发现代码显得很臃肿。对于从field注入转过来+有强迫症的园友 来说，简直可以说是石乐志 (\`Д´*)9。对于这一点我们后面再来讨论，别急。</p><h3 id="_2-3-setter注入" tabindex="-1"><a class="header-anchor" href="#_2-3-setter注入"><span>2.3 setter注入</span></a></h3><pre><code class="language-java">@Controller
public class FooController {
...
</code></pre><h3 id="getbean" tabindex="-1"><a class="header-anchor" href="#getbean"><span>getbean</span></a></h3><p>其实还有一种方法,就是getbean 通过context获取bean,并可以在各个地方使用</p><pre><code class="language-java">public class LoginContextHolder {
