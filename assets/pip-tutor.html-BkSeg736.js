import{_ as e,c as p,o as t,d as n}from"./app-CbULZrmi.js";const i={},o=n(`<h1 id="pip使用" tabindex="-1"><a class="header-anchor" href="#pip使用"><span>pip使用</span></a></h1><h2 id="安装python" tabindex="-1"><a class="header-anchor" href="#安装python"><span>安装python</span></a></h2><p>在 Python Releases for Windows 页面下载你需要的那个版本的 Windows embeddable package (64-bit) 文件，这样就得到一个 python-x.x.x-embed-amd64.zip 文件。将这个压缩包文件解压到任意目录下</p><p>在目录中找到 <code>pythonxxx._pth</code> 文件，去掉 <code>import site</code> 前的注释符，使 Lib\\site-packages 加入 sys.path 中。</p><p>现在执行 .\\python.exe 命令就可以先进入嵌入式环境，然后我们要下载 get-pip 文件并安装 pip 命令：</p><pre><code class="language-shell">
curl -o &quot;get-pip.py&quot; &quot;https://bootstrap.pypa.io/get-pip.py&quot;
.\\python.exe get-pip.py

</code></pre><p>这个时候目录下会产生两个新的 Lib 和 Scripts 文件夹，接下来就可以试试安装一个用于生成假数据的 Faker 库：</p><pre><code>.\\python.exe -m pip install faker
</code></pre><p>后续可以安装poetry,pipx,pipenv等库,不需要安装virualenv了</p><div class="hint-container tip"><p class="hint-container-title">提示</p><p>常用的全局包</p><pre><code class="language-python">pip install -U you-get pipenv rembg pyinstaller auto-py-to-exe httpie ipython mycli iredis pgcli
...
</code></pre></li></ul>`,37),a=[o];function s(r,l){return t(),p("div",null,a)}const d=e(i,[["render",s],["__file","pip-tutor.html.vue"]]),h=JSON.parse('{"path":"/python-tutor/python-config/pip-tutor.html","title":"pip使用","lang":"zh-CN","frontmatter":{"description":"pip使用 安装python 在 Python Releases for Windows 页面下载你需要的那个版本的 Windows embeddable package (64-bit) 文件，这样就得到一个 python-x.x.x-embed-amd64.zip 文件。将这个压缩包文件解压到任意目录下 在目录中找到 pythonxxx._pth ...","head":[["meta",{"property":"og:url","content":"https://yzqdev.github.io/cs-guide/cs-guide/python-tutor/python-config/pip-tutor.html"}],["meta",{"property":"og:site_name","content":"cs-guide"}],["meta",{"property":"og:title","content":"pip使用"}],["meta",{"property":"og:description","content":"pip使用 安装python 在 Python Releases for Windows 页面下载你需要的那个版本的 Windows embeddable package (64-bit) 文件，这样就得到一个 python-x.x.x-embed-amd64.zip 文件。将这个压缩包文件解压到任意目录下 在目录中找到 pythonxxx._pth ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-02-07T08:48:51.000Z"}],["meta",{"property":"article:author","content":"yzqdev"}],["meta",{"property":"article:modified_time","content":"2024-02-07T08:48:51.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"pip使用\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-02-07T08:48:51.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yzqdev\\",\\"url\\":\\"http://www.yzqdev.top\\"}]}"]]},"headers":[{"level":2,"title":"安装python","slug":"安装python","link":"#安装python","children":[]},{"level":2,"title":"安装","slug":"安装","link":"#安装","children":[]},{"level":2,"title":"配置国内镜像源","slug":"配置国内镜像源","link":"#配置国内镜像源","children":[]},{"level":2,"title":"安装依赖","slug":"安装依赖","link":"#安装依赖","children":[]},{"level":2,"title":"Ubuntu 安装最新版本的 Python3.10","slug":"ubuntu-安装最新版本的-python3-10","link":"#ubuntu-安装最新版本的-python3-10","children":[]}],"git":{"createdTime":1647861419000,"updatedTime":1707295731000,"contributors":[{"name":"yzqdev","email":"yzqdev@outlook.com","commits":6}]},"readingTime":{"minutes":3.57,"words":1071},"filePathRelative":"python-tutor/python-config/pip-tutor.md","localizedDate":"2022年3月21日","autoDesc":true}');export{d as comp,h as data};
