import{_ as n,c as a,a as e,o as l}from"./app-BKQjDlOh.js";const p={};function i(t,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="go命令" tabindex="-1"><a class="header-anchor" href="#go命令"><span>go命令</span></a></h1><h2 id="go命令-1" tabindex="-1"><a class="header-anchor" href="#go命令-1"><span>go命令</span></a></h2><p>注意 cgo 不支持交叉编译</p><div class="language-powershell line-numbers-mode" data-highlighter="prismjs" data-ext="powershell"><pre><code class="language-powershell"><span class="line"><span class="token keyword">param</span> <span class="token punctuation">(</span></span>
