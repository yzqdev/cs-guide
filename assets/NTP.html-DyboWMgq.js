import{_ as e,c as l,a as s,o as i}from"./app-Die-Lcms.js";const a={};function p(t,n){return i(),l("div",null,n[0]||(n[0]=[s(`<h1 id="ntp-network-time-protocol-介绍" tabindex="-1"><a class="header-anchor" href="#ntp-network-time-protocol-介绍"><span>NTP（Network Time Protocol）介绍</span></a></h1><h2 id="ntp-安装" tabindex="-1"><a class="header-anchor" href="#ntp-安装"><span>NTP 安装</span></a></h2><ul><li><p>查看是否已安装：</p></li><li><p>CentOS：<code>rpm -qa | grep ntp-*</code></p></li><li><p>Ubuntu：<code>dpkg -l | grep ntp-*</code></p></li><li><p>安装：</p></li><li><p>CentOS 6/7：<code>sudo yum install -y ntp</code></p></li><li><p>Ubuntu：<code>sudo apt-get install -y ntp</code></p></li></ul><h2 id="配置阿里云-ntp-推荐" tabindex="-1"><a class="header-anchor" href="#配置阿里云-ntp-推荐"><span>配置阿里云 NTP（推荐）</span></a></h2><ul><li>官网介绍：<a href="https://help.aliyun.com/knowledge_detail/40583.html" target="_blank" rel="noopener noreferrer">https://help.aliyun.com/knowledge_detail/40583.html</a></li><li>配置文件介绍（记得先备份）：<code>sudo vim /etc/ntp.conf</code></li><li>注释掉以下默认的配置内容：</li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">server 0.centos.pool.ntp.org iburst</span>
...
<span class="line"></span></code></pre></div><ul><li>新增配置：</li></ul><div class="language-nginx" data-highlighter="prismjs" data-ext="nginx" data-title="nginx"><pre><code><span class="line">ntp1.aliyun.com</span>
...
<span class="line"></span></code></pre></div><ul><li>我的配置如下</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">driftfile  /var/lib/ntp/drift</span>
