import{i as e,r as t,s as n,t as r}from"./app-B1jqjtqq.js";var i=JSON.parse(`{"path":"/cs-tips/tool/go.html","title":"go命令","lang":"zh-CN","frontmatter":{"description":"go命令 go命令 注意 cgo 不支持交叉编译 使用pure go sqlite driver 或者使用https://github.com/msys2/msys2-installer/不要使用mingw windows上用不了 go 交叉编译 pm2命令 go 命令详解 提示 常用命令 关于gin打包 写一个build.ps1文件 相关信息 bui...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"go命令\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2023-05-25T04:34:06.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yzqdev\\",\\"url\\":\\"http://www.yzqdev.top\\"}]}"],["meta",{"property":"og:url","content":"https://yzqdev.github.io/cs-guide/cs-guide/cs-tips/tool/go.html"}],["meta",{"property":"og:site_name","content":"cs-guide"}],["meta",{"property":"og:title","content":"go命令"}],["meta",{"property":"og:description","content":"go命令 go命令 注意 cgo 不支持交叉编译 使用pure go sqlite driver 或者使用https://github.com/msys2/msys2-installer/不要使用mingw windows上用不了 go 交叉编译 pm2命令 go 命令详解 提示 常用命令 关于gin打包 写一个build.ps1文件 相关信息 bui..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2023-05-25T04:34:06.000Z"}],["meta",{"property":"article:modified_time","content":"2023-05-25T04:34:06.000Z"}]]},"git":{"createdTime":1684989246000,"updatedTime":1684989246000,"contributors":[{"name":"yzqdev","username":"yzqdev","email":"yzqdev@outlook.com","commits":1,"url":"https://github.com/yzqdev"}]},"readingTime":{"minutes":14.96,"words":4488},"filePathRelative":"cs-tips/tool/go.md","autoDesc":true}`),a={name:`go.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="go命令" tabindex="-1"><a class="header-anchor" href="#go命令"><span>go命令</span></a></h1><h2 id="go命令-1" tabindex="-1"><a class="header-anchor" href="#go命令-1"><span>go命令</span></a></h2><p>注意 cgo 不支持交叉编译</p><div class="language-powershell line-numbers-mode" data-highlighter="prismjs" data-ext="powershell"><pre><code class="language-powershell"><span class="line"><span class="token keyword">param</span> <span class="token punctuation">(</span></span>
...
<span class="line"></span></code></pre></div>`,47)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};