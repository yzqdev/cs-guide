import{_ as t,c as e,o,d as n}from"./app-CbULZrmi.js";const l={},a=n(`<h1 id="dotnet命令" tabindex="-1"><a class="header-anchor" href="#dotnet命令"><span>dotnet命令</span></a></h1><h1 id="dotnet命令-1" tabindex="-1"><a class="header-anchor" href="#dotnet命令-1"><span>dotnet命令</span></a></h1><div class="hint-container tip"><p class="hint-container-title">提示</p><p>最常用的dotnet命令</p><pre><code class="language-powershell">dotnet watch run
dotnet build
dotnet restore
...
</code></pre><ul><li>PublishSingleFile. 启用单文件发布。 此外，还会在 dotnet build 期间启用单文件警告。</li><li>SelfContained. 确定应用是独立的还是依赖于框架的。</li><li>RuntimeIdentifier. 指定目标 OS 和 CPU 类型。 默认情况下，还会设置 <code>&lt;SelfContained&gt;true&lt;/SelfContained&gt;</code>。</li><li>PublishReadyToRun. 启用预先 (AOT) 编译。</li></ul>`,28),r=[a];function i(s,d){return o(),e("div",null,r)}const p=t(l,[["render",i],["__file","dotnet.html.vue"]]),u=JSON.parse('{"path":"/cs-tips/tool/dotnet.html","title":"dotnet命令","lang":"zh-CN","frontmatter":{"description":"dotnet命令 dotnet命令 提示 最常用的dotnet命令 dotnet添加tab补全 官网 把下面的代码添加到powershell配置文件 安装全局工具 一些好用的全局工具 链接 打包发布 使用msbuild 使用msbuild 打包程序 使用cli 生成单个exe文件 打包生成单个文件 关于更多命令,见官网 其中rid windows wi...","head":[["meta",{"property":"og:url","content":"https://yzqdev.github.io/cs-guide/cs-guide/cs-tips/tool/dotnet.html"}],["meta",{"property":"og:site_name","content":"cs-guide"}],["meta",{"property":"og:title","content":"dotnet命令"}],["meta",{"property":"og:description","content":"dotnet命令 dotnet命令 提示 最常用的dotnet命令 dotnet添加tab补全 官网 把下面的代码添加到powershell配置文件 安装全局工具 一些好用的全局工具 链接 打包发布 使用msbuild 使用msbuild 打包程序 使用cli 生成单个exe文件 打包生成单个文件 关于更多命令,见官网 其中rid windows wi..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2023-05-25T04:34:06.000Z"}],["meta",{"property":"article:author","content":"yzqdev"}],["meta",{"property":"article:modified_time","content":"2023-05-25T04:34:06.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"dotnet命令\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2023-05-25T04:34:06.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yzqdev\\",\\"url\\":\\"http://www.yzqdev.top\\"}]}"]]},"headers":[{"level":2,"title":"dotnet添加tab补全","slug":"dotnet添加tab补全","link":"#dotnet添加tab补全","children":[]},{"level":2,"title":"安装全局工具","slug":"安装全局工具","link":"#安装全局工具","children":[{"level":3,"title":"一些好用的全局工具","slug":"一些好用的全局工具","link":"#一些好用的全局工具","children":[]}]},{"level":2,"title":"打包发布","slug":"打包发布","link":"#打包发布","children":[]}],"git":{"createdTime":1653752204000,"updatedTime":1684989246000,"contributors":[{"name":"yzqdev","email":"yzqdev@outlook.com","commits":1}]},"readingTime":{"minutes":1.77,"words":532},"filePathRelative":"cs-tips/tool/dotnet.md","localizedDate":"2022年5月28日","autoDesc":true}');export{p as comp,u as data};
