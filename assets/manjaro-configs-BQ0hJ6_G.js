import{i as e,r as t,s as n,t as r}from"./app-Bmf6MlmU.js";var i=JSON.parse(`{"path":"/linux-tutor/linux-tips/manjaro-configs.html","title":"配置manjaro","lang":"zh-CN","frontmatter":{"description":"配置manjaro 提示 记得进入设置&gt;工作空间行为&gt;锁屏&gt;关闭自动锁屏，不然会卡死在登陆 分区工具的使用 partitionmanager pacman 的日常使用 安装todesk远程控制 更换源 更新文件夹语言 安装常用的软件 安装docker 安装java （https://wiki.archlinux.org/index.p...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"配置manjaro\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-07-15T12:37:10.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yzqdev\\",\\"url\\":\\"http://www.yzqdev.top\\"}]}"],["meta",{"property":"og:url","content":"https://yzqdev.github.io/cs-guide/cs-guide/linux-tutor/linux-tips/manjaro-configs.html"}],["meta",{"property":"og:site_name","content":"cs-guide"}],["meta",{"property":"og:title","content":"配置manjaro"}],["meta",{"property":"og:description","content":"配置manjaro 提示 记得进入设置&gt;工作空间行为&gt;锁屏&gt;关闭自动锁屏，不然会卡死在登陆 分区工具的使用 partitionmanager pacman 的日常使用 安装todesk远程控制 更换源 更新文件夹语言 安装常用的软件 安装docker 安装java （https://wiki.archlinux.org/index.p..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-07-15T12:37:10.000Z"}],["meta",{"property":"article:modified_time","content":"2026-07-15T12:37:10.000Z"}]]},"git":{"createdTime":1647861419000,"updatedTime":1784119030000,"contributors":[{"name":"yzqdev","username":"yzqdev","email":"yzqdev@outlook.com","commits":3,"url":"https://github.com/yzqdev"}]},"readingTime":{"minutes":10.86,"words":3258},"filePathRelative":"linux-tutor/linux-tips/manjaro-configs.md","autoDesc":true}`),a={name:`manjaro-configs.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="配置manjaro" tabindex="-1"><a class="header-anchor" href="#配置manjaro"><span>配置manjaro</span></a></h1><div class="hint-container tip"><p class="hint-container-title">提示</p><p>记得进入设置&gt;工作空间行为&gt;锁屏&gt;关闭自动锁屏，不然会卡死在登陆</p></div><blockquote><h2 id="分区工具的使用-partitionmanager" tabindex="-1"><a class="header-anchor" href="#分区工具的使用-partitionmanager"><span>分区工具的使用 partitionmanager</span></a></h2></blockquote><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token function">sudo</span> yay <span class="token parameter variable">-S</span> partitionmanager</span>
...
<span class="line">用了kde以后，每次打开浏览器都会跳出电子钱包等，影响使用体验</span>
<span class="line">于是就想办法把他关掉！</span>
<span class="line">搜索Kwallet， 不是KwalletManager</span>
<span class="line">然后把启用的勾勾去掉即可</span>
...
<span class="line"><span class="token operator">~</span><span class="token operator">/</span><span class="token punctuation">.</span>bashrc<span class="token operator">:</span> 该文件包含专用于当前用户的 bash shell 的配置信息<span class="token punctuation">,</span>当登录时以及每次打开新的shell时<span class="token punctuation">,</span>该该文件被读取<span class="token punctuation">.</span></span>
...
<span class="line"><span class="token comment"># 确认当前使用的 Shell 类型（通常为 bash 或 zsh）</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\xA0安装Anaconda后终端出现的(base)字样去除方法：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">conda config <span class="token parameter variable">--set</span> auto_activate_base False</span>
...
<span class="line"><span class="token comment">#7. ALTER USER &#39;root&#39;@&#39;localhost&#39; IDENTIFIED BY &#39;123456&#39;;# 然后退出mysql登陆即可</span></span>
...
<span class="line"></span></code></pre></div><p>其中，我将原本的en_US改为了zh_CN，未见异常。如需撤销，仅需将<code>&#39;/var/lib/postgres/data&#39;</code>下面的内容清空。 启动/开机启动 PostgreSQL：</p><div class="language-css" data-highlighter="prismjs" data-ext="css"><pre><code class="language-css"><span class="line">systemctl start postgresql.service</span>
...
<span class="line"></span></code></pre></div><p>要退出psql或返回原用户，都是用<code>exit</code>命令。 PostgreSQL的用户跟系统用户有些关联，前者必须也是后者。在初始化过程中会在系统中创建postgres用户，同时也是数据库的超级权限用户，postgres用户可以创建其他数据库用户。</p><blockquote><p>提示： 若创建一个与系统用户同名的数据库用户，并允许其访问 PostgreSQL 数据库，则在登录 PostgreSQL 数据库 shell 时无需切换用户（这样做会比较方便）。</p></blockquote><h3 id="通用基本操作-1" tabindex="-1"><a class="header-anchor" href="#通用基本操作-1"><span>通用基本操作<a href="#fn1">[1]</a></span></a></h3><h4 id="数据库shell外" tabindex="-1"><a class="header-anchor" href="#数据库shell外"><span>数据库shell外</span></a></h4><p>添加数据库（须在原用户操作）：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">createdb myDatabaseName</span>
...
<span class="line"></span></code></pre></div>`,106)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};