import{_ as n,c as e,o as _,d as o}from"./app-CbULZrmi.js";const t={},r=o(`<h1 id="mysql配置" tabindex="-1"><a class="header-anchor" href="#mysql配置"><span>mysql配置</span></a></h1><h2 id="配置mysql-1g" tabindex="-1"><a class="header-anchor" href="#配置mysql-1g"><span>配置mysql-1g</span></a></h2><pre><code class="language-cnf">
# 适用于 Mysql 5.6
...
read_buffer = 4M
write_buffer = 4M
</code></pre><pre><code class="language-cnf">
# 适用于 Mysql 5.6
# 该配置适合 1G 内存左右的机子，储存类型为 InnoDB
# 官网配置说明：http://dev.mysql.com/doc/refman/5.6/en/mysqld-option-tables.html
# 官网状态值说明：http://dev.mysql.com/doc/refman/5.6/en/server-status-variables.html
...
read_buffer = 4M
write_buffer = 4M
</code></pre><h2 id="mysql-8g" tabindex="-1"><a class="header-anchor" href="#mysql-8g"><span>mysql-8g</span></a></h2><pre><code class="language-cnf">[mysql]
port = 3306
socket = /usr/program/mysql/data/mysql.sock
default-character-set = utf8
...
read_buffer = 20M
write_buffer = 20M
</code></pre><h2 id="mysql-windows" tabindex="-1"><a class="header-anchor" href="#mysql-windows"><span>mysql-windows</span></a></h2><pre><code class="language-ini">[client]
no-beep
port=3306
