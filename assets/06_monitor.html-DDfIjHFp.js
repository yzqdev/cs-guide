import{_ as e,c as t,o as r,d as a}from"./app-CbULZrmi.js";const n={},o=a(`<h1 id="性能监控" tabindex="-1"><a class="header-anchor" href="#性能监控"><span>性能监控</span></a></h1><div class="hint-container tip"><p class="hint-container-title">提示</p><p>在使用操作系统的过程中，我们经常需要查看当前的性能如何，需要了解CPU、内存和硬盘的使用情况； 本节介绍的这几个工具能满足日常工作要求；</p></div><h2 id="监控cpu" tabindex="-1"><a class="header-anchor" href="#监控cpu"><span>监控CPU</span></a></h2><p>查看CPU使用率 :</p><pre><code>$sar -u
