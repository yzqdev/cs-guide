...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>public class MainActivity extends Activity { private ProgressDialog progress; Button b1,b2;</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>  @Override
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>}</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>
...
&lt;/RelativeLayout&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>让我们尝试运行刚刚修改的应用程序。我假设您在进行环境设置时已创建了AVD。要从Android Studio运行该应用，请打开您项目的活动文件之一，然后工具栏中单击“运行”图标。Android studio将应用程序安装在您的AVD上并启动它，如果设置和应用程序一切正常，它将显示在“模拟器”窗口下面-</p><p><img src="https://www.jc2182.com/images/android/event1.png" alt=""></p><p>点击“大字体”按钮，如下界面</p><p><img src="https://www.jc2182.com/images/android/event2.png" alt=""></p><blockquote><p>我建议尝试为不同的事件类型编写不同的事件处理程序，并了解不同事件类型及其处理方式的确切区别。与菜单，微调器，选择器小部件相关的事件几乎没有什么不同，但它们也基于与上述相同的概念。</p></blockquote>`,11);function b(h,g){const a=i("ExternalLinkIcon");return o(),l("div",null,[u,n("ol",null,[n("li",null,[s("您将使用Android Studio创建一个Android应用程序，并将其命名为Demo，位于com.jc2182.demo包下，如"),n("a",p,[s("Hello World示例"),d(a)]),s("一章中所述。")]),r,v,m]),k])}const w=e(c,[["render",b],["__file","events.html.vue"]]),y=JSON.parse('{"path":"/android-tutor/interface/events.html","title":"事件","lang":"zh-CN","frontmatter":{"description":"事件 事件是一种收集有关用户与应用程序的交互式组件进行交互的数据的有用方法。像按下按钮或触摸屏幕等。Android框架将事件队列保持为先进先出（FIFO）的基础。您可以在程序中捕获这些事件，并根据要求采取适当的措施。 与Android事件管理相关的以下三个概念- 事件监听器 - 事件监听器是View类中的一个接口，其中包含一个回调方法。当用户与UI中的...","head":[["meta",{"property":"og:url","content":"https://yzqdev.github.io/cs-guide/cs-guide/android-tutor/interface/events.html"}],["meta",{"property":"og:site_name","content":"cs-guide"}],["meta",{"property":"og:title","content":"事件"}],["meta",{"property":"og:description","content":"事件 事件是一种收集有关用户与应用程序的交互式组件进行交互的数据的有用方法。像按下按钮或触摸屏幕等。Android框架将事件队列保持为先进先出（FIFO）的基础。您可以在程序中捕获这些事件，并根据要求采取适当的措施。 与Android事件管理相关的以下三个概念- 事件监听器 - 事件监听器是View类中的一个接口，其中包含一个回调方法。当用户与UI中的..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://www.jc2182.com/images/android/event1.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2023-06-25T05:00:38.000Z"}],["meta",{"property":"article:author","content":"yzqdev"}],["meta",{"property":"article:modified_time","content":"2023-06-25T05:00:38.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"事件\\",\\"image\\":[\\"https://www.jc2182.com/images/android/event1.png\\",\\"https://www.jc2182.com/images/android/event2.png\\"],\\"dateModified\\":\\"2023-06-25T05:00:38.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yzqdev\\",\\"url\\":\\"http://www.yzqdev.top\\"}]}"]]},"headers":[{"level":2,"title":"事件监听器和事件处理程序","slug":"事件监听器和事件处理程序","link":"#事件监听器和事件处理程序","children":[]},{"level":2,"title":"事件监听器注册","slug":"事件监听器注册","link":"#事件监听器注册","children":[]},{"level":2,"title":"触控模式","slug":"触控模式","link":"#触控模式","children":[]},{"level":2,"title":"焦点","slug":"焦点","link":"#焦点","children":[]},{"level":2,"title":"事件处理示例","slug":"事件处理示例","link":"#事件处理示例","children":[]}],"git":{"createdTime":1687669238000,"updatedTime":1687669238000,"contributors":[{"name":"yzqdev","email":"yzqdev@outlook.com","commits":1}]},"readingTime":{"minutes":6.45,"words":1934},"filePathRelative":"android-tutor/interface/events.md","localizedDate":"2023年6月25日","autoDesc":true}');export{w as comp,y as data};
