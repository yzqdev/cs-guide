import{_ as a,c as n,a as e,o as l}from"./app-Die-Lcms.js";const p={};function i(t,s){return l(),n("div",null,s[0]||(s[0]=[e(`<h1 id="配置manjaro" tabindex="-1"><a class="header-anchor" href="#配置manjaro"><span>配置manjaro</span></a></h1><div class="hint-container tip"><p class="hint-container-title">提示</p><p>记得进入设置&gt;工作空间行为&gt;锁屏&gt;关闭自动锁屏，不然会卡死在登陆</p></div><blockquote><h2 id="分区工具的使用-partitionmanager" tabindex="-1"><a class="header-anchor" href="#分区工具的使用-partitionmanager"><span>分区工具的使用 partitionmanager</span></a></h2></blockquote><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">sudo</span> yay <span class="token parameter variable">-S</span> partitionmanager</span>
<span class="line"></span></code></pre></div><blockquote><h2 id="pacman-的日常使用" tabindex="-1"><a class="header-anchor" href="#pacman-的日常使用"><span>pacman 的日常使用</span></a></h2></blockquote><p>安装todesk远程控制</p><div class="language-javascript" data-highlighter="prismjs" data-ext="js" data-title="js"><pre><code><span class="line">yay <span class="token operator">-</span>Ss todesk</span>
...
<span class="line"></span></code></pre></div><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">pacman <span class="token parameter variable">-S</span> xx1 xx2   <span class="token comment"># 安装或升级软件包，或者一列软件包（包含依赖包）</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="更换源" tabindex="-1"><a class="header-anchor" href="#更换源"><span>更换源</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">//1.配置镜像源:</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="更新文件夹语言" tabindex="-1"><a class="header-anchor" href="#更新文件夹语言"><span>更新文件夹语言</span></a></h2><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">export LANG=en_US</span>
<span class="line">xdg-user-dirs-gtk-update  //弹出对话框，问是否改成英文，点是，并且选“不再提示”</span>
<span class="line">export LANG=zh_CN</span>
<span class="line"></span></code></pre></div><h2 id="安装常用的软件" tabindex="-1"><a class="header-anchor" href="#安装常用的软件"><span>安装常用的软件</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">yay <span class="token parameter variable">-S</span> net-tools base-devel</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="安装docker" tabindex="-1"><a class="header-anchor" href="#安装docker"><span>安装docker</span></a></h2><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">sudo</span> pacman <span class="token parameter variable">-S</span> <span class="token function">docker</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">先配置下载github太慢</span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="安装miniconda" tabindex="-1"><a class="header-anchor" href="#安装miniconda"><span>安装miniconda</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">从清华镜像下载miniconda执行的sh</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>安装Anaconda后终端出现的(base)字样去除方法：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">conda config <span class="token parameter variable">--set</span> auto_activate_base False</span>
<span class="line"></span></code></pre></div><h2 id="安装输入法" tabindex="-1"><a class="header-anchor" href="#安装输入法"><span>安装输入法</span></a></h2><p>设置小键盘开机自动启动方法 打开设置 找到输入设备-&gt;键盘 -&gt; plasma启动时numlock状态-&gt;开启即可 关闭触控板也是输入设备-&gt;触摸板</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">下载fcitx5并安装</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="安装golang" tabindex="-1"><a class="header-anchor" href="#安装golang"><span>安装golang</span></a></h2><h3 id="_1-使用pacman-yay" tabindex="-1"><a class="header-anchor" href="#_1-使用pacman-yay"><span>1.使用pacman/yay</span></a></h3><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">sudo</span> pacman <span class="token parameter variable">-S</span> go go-tools</span>
<span class="line"></span></code></pre></div><blockquote><p>可选用 <code>gcc-go</code> ，但若需要使用 JetBrains 的 IDE 则必须使用 <code>go</code> ，否则 IDE 无法在 <code>/usr/lib/go</code> 下找到 Go SDK。</p></blockquote><h3 id="_2-从官网下载" tabindex="-1"><a class="header-anchor" href="#_2-从官网下载"><span>2.从官网下载</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">在golang官网下载go的安装包，go1.16.linux-amd64.tar.gz 然后</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="安装teamviewer" tabindex="-1"><a class="header-anchor" href="#安装teamviewer"><span>安装teamviewer</span></a></h2><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">yay <span class="token parameter variable">-S</span> teamviewer</span>
...
<span class="line"></span></code></pre></div><h2 id="安装myql-已经被替换为mariadb-请使用下面的方法" tabindex="-1"><a class="header-anchor" href="#安装myql-已经被替换为mariadb-请使用下面的方法"><span>安装myql：（已经被替换为mariadb,请使用下面的方法）</span></a></h2><p>如果要使用mysql8,需要设置aur！！！！！！！</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">//下载Mysql</span>
...
<span class="line"></span></code></pre></div><p>如果忘记密码，直接百度mysql8忘记密码怎么办</p><h3 id="manjaro-。忘记密码解决办法" tabindex="-1"><a class="header-anchor" href="#manjaro-。忘记密码解决办法"><span>manjaro 。忘记密码解决办法</span></a></h3><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 1.先编辑mysql配置文件</span></span>
...
<span class="line"></span></code></pre></div><h2 id="如果出现" tabindex="-1"><a class="header-anchor" href="#如果出现"><span>如果出现</span></a></h2><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">ER_NOT_SUPPORTED_AUTH_MODE: Client does not support authentication protocol requested by server; consider upgrading MySQL client</span>
<span class="line"></span></code></pre></div><p>命令行进入mysql输入</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">ALTER <span class="token environment constant">USER</span> <span class="token string">&#39;root&#39;</span>@<span class="token string">&#39;localhost&#39;</span> IDENTIFIED WITH mysql_native_password BY <span class="token string">&#39;123456&#39;</span></span>
<span class="line"></span></code></pre></div><p>就可以连上了</p><h2 id="安装mariadb" tabindex="-1"><a class="header-anchor" href="#安装mariadb"><span>安装mariadb</span></a></h2><h2 id="_1-安装-与ubuntu不同-arch默认已经不再支持mysql-但是可以安装mariadb-其比mysql的性能更好且操作基本相同。-输入下面命令安装" tabindex="-1"><a class="header-anchor" href="#_1-安装-与ubuntu不同-arch默认已经不再支持mysql-但是可以安装mariadb-其比mysql的性能更好且操作基本相同。-输入下面命令安装"><span>1. 安装 与Ubuntu不同，arch默认已经不再支持MySQL，但是可以安装MariaDB，其比MySQL的性能更好且操作基本相同。 输入下面命令安装</span></a></h2><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">systemctl stop mysqld    //停止mysql服务</span>
...
<span class="line"></span></code></pre></div><h2 id="_2-启动" tabindex="-1"><a class="header-anchor" href="#_2-启动"><span>2. 启动</span></a></h2><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">systemctl start mariadb</span>
<span class="line">mysql_secure_installation    //设置密码等管理操作</span>
<span class="line">systemctl restart mariadb</span>
<span class="line">复制代码</span>
<span class="line"></span></code></pre></div><p>登录：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">mysql -u root -p</span>
<span class="line"></span></code></pre></div><h2 id="安装postgressql" tabindex="-1"><a class="header-anchor" href="#安装postgressql"><span>安装postgressql</span></a></h2><p>安装：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">sudo</span> pacman <span class="token parameter variable">-S</span>  postgresql</span>
<span class="line"></span></code></pre></div><p>初始化(必须)：</p><div class="language-swift" data-highlighter="prismjs" data-ext="swift" data-title="swift"><pre><code><span class="line">sudo su <span class="token operator">-</span> postgres <span class="token operator">-</span>c <span class="token string-literal"><span class="token string">&quot;initdb --locale zh_CN.UTF-8 -E UTF8 -D &#39;/var/lib/postgres/data&#39;&quot;</span></span></span>
<span class="line"></span></code></pre></div><p>其中，我将原本的en_US改为了zh_CN，未见异常。想要撤销的话，只需要把<code>&#39;/var/lib/postgres/data&#39;</code>下面的内容清空。 启动/开机启动 PostgreSQL：</p><div class="language-css" data-highlighter="prismjs" data-ext="css" data-title="css"><pre><code><span class="line">systemctl start postgresql.service</span>
<span class="line">systemctl enable postgresql.service</span>
<span class="line"></span></code></pre></div><p>切换到postgres用户，然后登录（初始无密码）：</p><div class="language-undefined" data-highlighter="prismjs" data-ext="undefined" data-title="undefined"><pre><code><span class="line">sudo -i -u postgres</span>
<span class="line">psql</span>
<span class="line"></span></code></pre></div><p>要退出psql或返回原用户，都是用<code>exit</code>命令。 PostgreSQL的用户跟系统用户有些关联，前者必须也是后者。在初始化过程中会在系统中创建postgres用户，同时也是数据库的超级权限用户，postgres用户可以创建其他数据库用户。</p><blockquote><p>提示： 如果创建一个与你的系统用户同名的数据库用户，并允许其访问 PostgreSQL 数据库，那么在登录PostgreSQL 数据库 shell 的时候无需切换用户（这样做会比较方便）。</p></blockquote><h3 id="通用基本操作-1" tabindex="-1"><a class="header-anchor" href="#通用基本操作-1"><span>通用基本操作<a href="#fn1">[1]</a></span></a></h3><h4 id="数据库shell外" tabindex="-1"><a class="header-anchor" href="#数据库shell外"><span>数据库shell外</span></a></h4><p>添加数据库（须在原用户操作）：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">createdb myDatabaseName</span>
<span class="line"></span></code></pre></div><p>连接数据库shell（须用postgres用户，所以先切一下用户）：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">sudo</span> <span class="token parameter variable">-i</span> <span class="token parameter variable">-u</span> postgres</span>
<span class="line">psql <span class="token parameter variable">-d</span> myDatabaseName</span>
<span class="line"></span></code></pre></div><p>也可以一步进入postgres用户的myDatabaseName数据库，与上面效果一样：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">psql <span class="token parameter variable">-U</span> postgres <span class="token parameter variable">-d</span> myDatabaseName</span>
<span class="line"></span></code></pre></div><p>若要创建用户，要在数据库程序外，用postgres用户执行：</p><div class="language-undefined" data-highlighter="prismjs" data-ext="undefined" data-title="undefined"><pre><code><span class="line">createuser --interactive myUserName</span>
<span class="line"></span></code></pre></div><h4 id="数据库shell内" tabindex="-1"><a class="header-anchor" href="#数据库shell内"><span>数据库shell内</span></a></h4><p>注意：数据库内的SQL语句，建议大写，必须分号结尾。 进入数据库后可修改密码：</p><div class="language-dart" data-highlighter="prismjs" data-ext="dart" data-title="dart"><pre><code><span class="line">alter user postgres <span class="token keyword">with</span> password <span class="token string-literal"><span class="token string">&#39; *** 密码 *** &#39;</span></span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre></div><p>如果有其他用户，可以把postgres换成其他用户的名。 一些常用的命令：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token punctuation">\\</span>c myDatabaseName     <span class="token comment"># 连接到数据库myDatabaseName</span></span>
...
<span class="line"></span></code></pre></div><h2 id="开启ssh服务" tabindex="-1"><a class="header-anchor" href="#开启ssh服务"><span>开启ssh服务</span></a></h2><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">systemctl <span class="token builtin class-name">enable</span> sshd.service 开机启动</span>
<span class="line">systemctl start sshd.service 立即启动</span>
<span class="line">systemctl restart sshd.service 立即重启</span>
<span class="line"></span></code></pre></div><h2 id="安装nginx" tabindex="-1"><a class="header-anchor" href="#安装nginx"><span>安装nginx</span></a></h2><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">yay <span class="token parameter variable">-S</span> nginx-mainline</span>
<span class="line"></span></code></pre></div><h2 id="安装redis" tabindex="-1"><a class="header-anchor" href="#安装redis"><span>安装redis</span></a></h2><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">yay <span class="token parameter variable">-S</span> redis</span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><p>配置redis密码：在<code>/etc/redis.conf</code>中找到requirepass,去掉h注释并更换为自己的密码； 出现</p><h3 id="system-limit-for-number-of-file-watchers-reached" tabindex="-1"><a class="header-anchor" href="#system-limit-for-number-of-file-watchers-reached"><span>System limit for number of file watchers reached</span></a></h3><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token builtin class-name">echo</span> fs.inotify.max_user_watches <span class="token operator">=</span> <span class="token number">524288</span> <span class="token operator">|</span> <span class="token function">sudo</span> <span class="token function">tee</span> <span class="token parameter variable">-a</span> /etc/sysctl.conf </span>
...
<span class="line"></span></code></pre></div><h2 id="安装php和composer" tabindex="-1"><a class="header-anchor" href="#安装php和composer"><span>安装php和composer</span></a></h2><p>安装php：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">yay <span class="token parameter variable">-S</span> php</span>
<span class="line"></span></code></pre></div><p>第一步，下载composer。（切换到项目的根目录，再执行）</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">php <span class="token parameter variable">-r</span> <span class="token string">&quot;readfile(&#39;https://getcomposer.org/installer&#39;);&quot;</span> <span class="token operator">|</span> php</span>
<span class="line"></span></code></pre></div><p>下载之后后自动安装，执行 php composer.phar。查看composer是否安装成功。 第二步，将composer.phar文件移动到bin目录以便全局使用composer命令</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">cp</span> <span class="token parameter variable">-r</span> composer.phar /usr/local/bin/composer</span>
<span class="line"></span></code></pre></div><p>（如果只是针对某个项目使用composer,可忽略此步） 第三步，切换国内源（如果第一步下载成功，可忽略此步）</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">composer</span> config <span class="token parameter variable">-g</span> repo.packagist <span class="token function">composer</span> https://packagist.phpcomposer.com</span>
<span class="line"></span></code></pre></div><p>第四步，安装phpcgi</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">yay <span class="token parameter variable">-S</span> php-apache php-cgi php-fpm php-gd  php-embed php-intl php-imap  php-redis php-snmp</span>
<span class="line"></span></code></pre></div><p>第五步，安装pecl</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">wget</span> http://pear.php.net/go-pear.phar</span>
<span class="line">php go-pear.phar</span>
<span class="line"></span></code></pre></div><p>第六步，安装xdebug</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">sudo</span> pecl <span class="token function">install</span> xdebug</span>
<span class="line"></span>
