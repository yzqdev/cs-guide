import{_ as t,c as n,a as i,o as l}from"./app-B6vXTniy.js";const a={};function o(r,e){return l(),n("div",null,[...e[0]||(e[0]=[i(`<h1 id="nm-目标文件格式分析" tabindex="-1"><a class="header-anchor" href="#nm-目标文件格式分析"><span>nm 目标文件格式分析</span></a></h1><p>nm 命令显示关于指定 File 中符号的信息，文件可以是对象文件、可执行文件或对象文件库。如果文件没有包含符号信息，nm 命令报告该情况，但不把它解释为出错条件。 nm 命令缺省情况下报告十进制符号表示法下的数字值。</p><pre><code>$nm myProgrammer
08049f28 d _DYNAMIC
