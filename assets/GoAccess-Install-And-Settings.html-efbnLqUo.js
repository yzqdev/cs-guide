import{_ as e,c as s,a,o as l}from"./app-Die-Lcms.js";const i={};function t(c,n){return l(),s("div",null,n[0]||(n[0]=[a(`<h2 id="安装-centos-7-4" tabindex="-1"><a class="header-anchor" href="#安装-centos-7-4"><span>安装（CentOS 7.4）</span></a></h2><ul><li><p>注意，如果是在 CentOS 6 下安装会碰到一些问题，可以参考：<a href="https://www.jianshu.com/p/7cacc1d20588" target="_blank" rel="noopener noreferrer">https://www.jianshu.com/p/7cacc1d20588</a></p></li><li><ol><li>安装依赖包</li></ol></li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">yum install -y ncurses-devel</span>
...
<span class="line"></span></code></pre></div><ul><li><ol start="2"><li>安装 GoAccess</li></ol></li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">wget http://tar.goaccess.io/goaccess-1.2.tar.gz</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre></div><ul><li>停止 nginx：<code>/usr/local/nginx/sbin/nginx -s stop</code></li><li>备份旧的 nginx log 文件：<code>mv /var/log/nginx/access.log /var/log/nginx/access.log.20180702back</code></li><li>启动 nginx：<code>/usr/local/nginx/sbin/nginx</code></li><li>创建 GoAccess 配置文件：<code>vim /etc/goaccess_log_conf_nginx.conf</code></li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">time-format %T</span>
<span class="line">date-format %d/%b/%Y</span>
<span class="line">log_format %h - %^ [%d:%t %^] &quot;%r&quot; %s %b &quot;%R&quot; &quot;%u&quot; &quot;%^&quot; %^ %^ %^ %T</span>
<span class="line"></span></code></pre></div><h2 id="使用" tabindex="-1"><a class="header-anchor" href="#使用"><span>使用</span></a></h2><h4 id="在终端上展示数据" tabindex="-1"><a class="header-anchor" href="#在终端上展示数据"><span>在终端上展示数据</span></a></h4><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">goaccess -a -d -f /var/log/nginx/access.log -p /etc/goaccess_log_conf_nginx.conf</span>
<span class="line"></span></code></pre></div><h4 id="手动生成当前统计页面" tabindex="-1"><a class="header-anchor" href="#手动生成当前统计页面"><span>手动生成当前统计页面</span></a></h4><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">goaccess -f /var/log/nginx/access.log -p /etc/goaccess_log_conf_nginx.conf -o /usr/local/nginx/report/index.html</span>
<span class="line"></span></code></pre></div><ul><li>更多参数用法：</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">时间分布图上：按小时展示数据：</span>
...
<span class="line">	--ignore-panel=REMOTE_USER \\</span>
<span class="line">	--ignore-panel=GEO_LOCATION</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="方便执行命令创建脚本" tabindex="-1"><a class="header-anchor" href="#方便执行命令创建脚本"><span>方便执行命令创建脚本</span></a></h4><ul><li><code>vim goaccess_report_by_min.sh</code></li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">goaccess -f /var/log/nginx/access.log -p /etc/goaccess_log_conf_nginx.conf -o /usr/local/nginx/report/index.html --ignore-crawlers --hour-spec=min \\</span>
<span class="line">	--ignore-panel=VISITORS \\</span>
<span class="line">	--ignore-panel=REQUESTS_STATIC \\</span>
<span class="line">	--ignore-panel=NOT_FOUND \\</span>
<span class="line">	--ignore-panel=OS \\</span>
