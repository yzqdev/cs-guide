...
<span class="line"></span></code></pre></div><ul><li>开发机设置 hosts：</li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">47.91.22.116 youmeekhost1</span>
<span class="line">47.91.22.124 youmeekhost2</span>
<span class="line">47.74.6.138 youmeekhost3</span>
<span class="line"></span></code></pre></div><h4 id="zookeeper-集群" tabindex="-1"><a class="header-anchor" href="#zookeeper-集群"><span>Zookeeper 集群</span></a></h4><ul><li>节点 1：</li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">docker run -d --name=zookeeper1 --net=host --restart=always \\</span>
...
<span class="line"></span></code></pre></div><ul><li>节点 2：</li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">docker run -d --name=zookeeper2 --net=host --restart=always \\</span>
<span class="line">-v /data/docker/zookeeper/data:/data \\</span>
<span class="line">-v /data/docker/zookeeper/log:/datalog \\</span>
<span class="line">-v /etc/hosts:/etc/hosts \\</span>
...
<span class="line">-e &quot;ZOO_SERVERS=server.1=youmeekhost1:2888:3888 server.2=youmeekhost2:2888:3888 server.3=youmeekhost3:2888:3888&quot; \\</span>
<span class="line">zookeeper:latest</span>
<span class="line"></span></code></pre></div><ul><li>节点 3：</li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">docker run -d --name=zookeeper3 --net=host --restart=always \\</span>
<span class="line">-v /data/docker/zookeeper/data:/data \\</span>
<span class="line">-v /data/docker/zookeeper/log:/datalog \\</span>
<span class="line">-v /etc/hosts:/etc/hosts \\</span>
...
<span class="line"></span></code></pre></div><ul><li>节点 2 执行命令：<code>echo stat | nc youmeekhost2 2181</code>，能得到如下信息：</li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">Zookeeper version: 3.4.11-37e277162d567b55a07d1755f0b31c32e93c01a0, built on 11/01/2017 18:06 GMT</span>
<span class="line">Clients:</span>
...
<span class="line">Node count: 4</span>
<span class="line"></span></code></pre></div><ul><li>节点 3 执行命令：<code>echo stat | nc youmeekhost3 2181</code>，能得到如下信息：</li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">Zookeeper version: 3.4.11-37e277162d567b55a07d1755f0b31c32e93c01a0, built on 11/01/2017 18:06 GMT</span>
<span class="line">Clients:</span>
...
<span class="line">Mode: follower</span>
<span class="line">Node count: 4</span>
<span class="line"></span></code></pre></div><h5 id="kafka-集群" tabindex="-1"><a class="header-anchor" href="#kafka-集群"><span>Kafka 集群</span></a></h5><ul><li>节点 1 执行：</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">docker run -d --net=host --name=kafka1 \\</span>
