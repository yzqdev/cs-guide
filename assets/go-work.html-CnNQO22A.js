import{_ as n,c as a,a as e,o as t}from"./app-Die-Lcms.js";const o={};function p(c,s){return t(),a("div",null,s[0]||(s[0]=[e(`<h1 id="go-workspace" tabindex="-1"><a class="header-anchor" href="#go-workspace"><span>go workspace</span></a></h1><h2 id="基础命令" tabindex="-1"><a class="header-anchor" href="#基础命令"><span>基础命令</span></a></h2><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment">#创建 workspace 工作区</span></span>
...
<span class="line"></span></code></pre></div><h2 id="好处" tabindex="-1"><a class="header-anchor" href="#好处"><span>好处</span></a></h2><p>这里我们在demo项目就可以直接用libs里面的方法了 见demo的main.go</p><div class="language-go" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token keyword">package</span> main</span>
