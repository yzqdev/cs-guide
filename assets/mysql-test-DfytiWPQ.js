...
<span class="line"></span></code></pre></div><h3 id="测试" tabindex="-1"><a class="header-anchor" href="#测试"><span>测试</span></a></h3><ul><li><p>数据库：阿里云 RDS-MySQL-5.7-2C4G</p></li><li><p>测试机：阿里云 ECS-4C4G-CentOS7.6</p></li><li><p>根据测试，不同的 ECS 测试机，不同的 RDS 测试结果有时候差距挺大的，这个很蛋疼。</p></li><li><p>需要注意的是 tpcc 默认会读取 /var/lib/mysql/mysql.sock 这个 socket 文件。因此，如果 socket 文件不在相应路径，可创建软连接，或者通过TCP/IP的方式连接测试服务器</p></li><li><p>准备数据：</p></li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">cd /opt/tpcc-mysql</span>
...
<span class="line">select count(*) from warehouse;</span>
<span class="line">    80</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考" tabindex="-1"><a class="header-anchor" href="#参考"><span>参考</span></a></h2><ul><li><a href="https://my.oschina.net/moooofly/blog/152547" target="_blank" rel="noopener noreferrer">https://my.oschina.net/moooofly/blog/152547</a></li><li><a href="http://www.techug.com/post/mysql-mysqlslap.html" target="_blank" rel="noopener noreferrer">http://www.techug.com/post/mysql-mysqlslap.html</a></li><li><a href="http://jixiuf.github.io/blog/mysql%E5%8E%8B%E5%8A%9B%E6%B5%8B%E8%AF%95/" target="_blank" rel="noopener noreferrer">http://jixiuf.github.io/blog/mysql压力测试/</a></li><li><a href="http://blog.chinaunix.net/uid-25723371-id-3498970.html" target="_blank" rel="noopener noreferrer">http://blog.chinaunix.net/uid-25723371-id-3498970.html</a></li><li><a href="http://nsimple.top/archives/mysql-sysbench-tool.html" target="_blank" rel="noopener noreferrer">http://nsimple.top/archives/mysql-sysbench-tool.html</a></li><li><a href="https://dearhwj.gitbooks.io/itbook/content/test/performance_test_qps_tps.html" target="_blank" rel="noopener noreferrer">https://dearhwj.gitbooks.io/itbook/content/test/performance_test_qps_tps.html</a></li><li><a href="https://www.hi-linux.com/posts/38534.html" target="_blank" rel="noopener noreferrer">https://www.hi-linux.com/posts/38534.html</a></li></ul>`,66)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};