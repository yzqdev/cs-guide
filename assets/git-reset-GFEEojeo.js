...
<span class="line"></span></code></pre></div><p>简而言之，执行 git reset HEAD 以取消之前 git add 添加，但不希望包含在下一提交快照中的缓存。</p>`,35)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};