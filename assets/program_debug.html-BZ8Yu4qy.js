import{_ as n,c as e,a,o as l}from"./app-C8DxhDIZ.js";const i={};function p(d,s){return l(),e("div",null,s[0]||(s[0]=[a(`<h1 id="程序调试" tabindex="-1"><a class="header-anchor" href="#程序调试"><span>程序调试</span></a></h1><h2 id="进程调试" tabindex="-1"><a class="header-anchor" href="#进程调试"><span>进程调试</span></a></h2><h3 id="gdb-程序交互调试" tabindex="-1"><a class="header-anchor" href="#gdb-程序交互调试"><span>gdb 程序交互调试</span></a></h3><p>GDB是一个由GNU开源组织发布的、UNIX/LINUX操作系统下的、基于命令行的、功能强大的程序调试工具。</p><p>对于一名Linux下工作的c++程序员，gdb是必不可少的工具；</p><p>GDB中的命令固然很多，但我们只需掌握其中十个左右的命令，就大致可以完成日常的基本的程序调试工作。</p><p>以下从一个完整的调试过程简单说明最基本的几个命令;</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">    <span class="token variable">$gdb</span> programmer     <span class="token comment"># 启动gdb</span></span>
