...
<span class="line"></span>
<span class="line"></span></code></pre></div><p>此特性可以避免使用特定 Unicode 区间来进行内容类型判断，提升可读性和可维护性。</p><h3 id="_8-非转义序列的模板字符串" tabindex="-1"><a class="header-anchor" href="#_8-非转义序列的模板字符串"><span>8.非转义序列的模板字符串</span></a></h3><p>之前，<code>\\u</code>开始一个 unicode 转义，<code>\\x</code>开始一个十六进制转义，<code>\\</code>后跟一个数字开始一个八进制转义。这使得创建特定的字符串变得不可能，例如Windows文件路径 <code>C:\\uuu\\xxx\\111</code>。更多细节参考<a href="https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/template_strings" target="_blank" rel="noopener noreferrer">模板字符串</a>。</p>`,145)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};