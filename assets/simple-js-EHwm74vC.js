...
<span class="line"></span></code></pre></div><p>JavaScript 开发工具推荐</p><p>SpreadJS 纯前端表格控件是基于 HTML5 的 JavaScript 电子表格和网格功能控件，提供了完备的公式引擎、排序、过滤、输入控件、数据可视化、Excel 导入/导出等功能，适用于 .NET、Java 和移动端等各平台在线编辑类 Excel 功能的表格程序开发。</p>`,116)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};