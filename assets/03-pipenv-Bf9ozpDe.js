import{i as e,r as t,s as n,t as r}from"./app-Bmf6MlmU.js";var i=JSON.parse(`{"path":"/python-tutor/python-config/03-pipenv.html","title":"pipenv使用","lang":"zh-CN","frontmatter":{"order":3,"description":"pipenv使用 安装 安装python 安装包 windows安装后会自动吧pip和python加入到环境变量 安装pipenv 使用pipenv 配置在:Windows路径为：C:\\\\Users\\\\&lt;UserName&gt;\\\\pip\\\\pip.ini 推荐使用清华镜像 默认安装的虚拟环境都在c盘%userprofile%的.virtualenvs文...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"pipenv使用\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-07-16T05:29:15.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yzqdev\\",\\"url\\":\\"http://www.yzqdev.top\\"}]}"],["meta",{"property":"og:url","content":"https://yzqdev.github.io/cs-guide/cs-guide/python-tutor/python-config/03-pipenv.html"}],["meta",{"property":"og:site_name","content":"cs-guide"}],["meta",{"property":"og:title","content":"pipenv使用"}],["meta",{"property":"og:description","content":"pipenv使用 安装 安装python 安装包 windows安装后会自动吧pip和python加入到环境变量 安装pipenv 使用pipenv 配置在:Windows路径为：C:\\\\Users\\\\&lt;UserName&gt;\\\\pip\\\\pip.ini 推荐使用清华镜像 默认安装的虚拟环境都在c盘%userprofile%的.virtualenvs文..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-07-16T05:29:15.000Z"}],["meta",{"property":"article:modified_time","content":"2026-07-16T05:29:15.000Z"}]]},"git":{"createdTime":1658761077000,"updatedTime":1784179755000,"contributors":[{"name":"yzqdev","username":"yzqdev","email":"yzqdev@outlook.com","commits":8,"url":"https://github.com/yzqdev"}]},"readingTime":{"minutes":1.97,"words":592},"filePathRelative":"python-tutor/python-config/03-pipenv.md","autoDesc":true}`),a={name:`03-pipenv.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="pipenv使用" tabindex="-1"><a class="header-anchor" href="#pipenv使用"><span>pipenv使用</span></a></h1><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><p>安装python <a href="https://registry.npmmirror.com/binary.html?path=python/" target="_blank" rel="noopener noreferrer">安装包</a><br> windows安装后会自动吧pip和python加入到环境变量</p><h2 id="安装pipenv" tabindex="-1"><a class="header-anchor" href="#安装pipenv"><span>安装pipenv</span></a></h2><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">pip <span class="token function">install</span> pipenv </span>
...
<span class="line"></span></code></pre></div><h2 id="使用pipenv" tabindex="-1"><a class="header-anchor" href="#使用pipenv"><span>使用pipenv</span></a></h2><div class="language-txt" data-highlighter="prismjs" data-ext="txt"><pre><code class="language-txt"><span class="line">添加镜像</span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><p>配置在:Windows路径为：<code>C:\\Users\\&lt;UserName&gt;\\pip\\pip.ini</code></p><p>推荐使用清华镜像</p><div class="language-ini" data-highlighter="prismjs" data-ext="ini"><pre><code class="language-ini"><span class="line"><span class="token section"><span class="token punctuation">[</span><span class="token section-name selector">global</span><span class="token punctuation">]</span></span></span>
...
<span class="line"></span></code></pre></div><div class="language-toml" data-highlighter="prismjs" data-ext="toml"><pre><code class="language-toml"><span class="line"><span class="token punctuation">[</span><span class="token table class-name">global</span><span class="token punctuation">]</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></div>`,16)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};