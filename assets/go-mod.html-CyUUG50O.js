import{_ as n,c as a,a as e,o}from"./app-Die-Lcms.js";const p={};function l(t,s){return o(),a("div",null,s[0]||(s[0]=[e(`<h1 id="go语言-mod模块-modules-使用" tabindex="-1"><a class="header-anchor" href="#go语言-mod模块-modules-使用"><span>go语言 mod模块(Modules)使用</span></a></h1><blockquote><p>Go语言从诞生之初就一直有个被诟病的问题: 缺少一个行之有效的“官方”包依赖管理工具. 其原因是在Google内部，所有人都是在一个代码库上进行开发的,因此并不是非常需要.但是Go语言变成一个社区化的工程语言之后,这个问题被放大了.</p></blockquote><div class="language-go" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token number">1.</span> 设置 GO111MODULE</span>
...
<span class="line"></span></code></pre></div><p><a href="https://www.melvinvivas.com/go-version-1-11-modules/" target="_blank" rel="noopener noreferrer">参考文章</a></p><p><strong>go mod模块特点</strong></p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">1. 模块是相关Go包的集合(即一个模块可以包含多个package,一个包package包含多个go源文件)</span>
...
<span class="line"></span></code></pre></div><p><strong>go mod命令</strong></p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">   go mod download    下载依赖的module到本地cache（默认为<span class="token variable">$GOPATH</span>/pkg/mod目录）</span>
...
<span class="line"></span></code></pre></div><h3 id="_1-设置-go111module" tabindex="-1"><a class="header-anchor" href="#_1-设置-go111module"><span>1. 设置 GO111MODULE</span></a></h3><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">可以用环境变量 GO111MODULE 开启或关闭模块支持，它有三个可选值：off、on、auto,默认值是 auto.</span>
...
<span class="line"></span></code></pre></div><h3 id="_2-go模块使用说明" tabindex="-1"><a class="header-anchor" href="#_2-go模块使用说明"><span>2. go模块使用说明</span></a></h3><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token number">1</span>. <span class="token punctuation">(</span>GO111MODULE<span class="token operator">=</span>off,把项目放到<span class="token variable">$GOPATH</span>/src之外<span class="token punctuation">)</span>或者<span class="token punctuation">(</span>设置GO111MODULE<span class="token operator">=</span>on,把项目放到任意目录<span class="token punctuation">)</span>即可激活模块模式</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="_3-2-hellomod模块目录下-创建hello-go文件-并增加以下内容" tabindex="-1"><a class="header-anchor" href="#_3-2-hellomod模块目录下-创建hello-go文件-并增加以下内容"><span>3.2 hellomod模块目录下,创建hello.go文件, 并增加以下内容</span></a></h6><div class="language-go" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token keyword">package</span> hellomod</span>
<span class="line"></span>
...
<span class="line"> <span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre></div><h6 id="_3-4-hellomod模块目录下-运行模块测试-go-test-v-会输出以下内容" tabindex="-1"><a class="header-anchor" href="#_3-4-hellomod模块目录下-运行模块测试-go-test-v-会输出以下内容"><span>3.4 hellomod模块目录下,运行模块测试 &quot;go test -v&quot;会输出以下内容</span></a></h6><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token operator">==</span><span class="token operator">=</span> RUN   TestHello</span>
...
<span class="line"></span></code></pre></div><h6 id="_3-5-提交-hellomod-模块代码到github" tabindex="-1"><a class="header-anchor" href="#_3-5-提交-hellomod-模块代码到github"><span>3.5 提交 hellomod 模块代码到github</span></a></h6><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 提交代码到github</span></span>
...
<span class="line"></span></code></pre></div><h6 id="_3-6-回到examples目录并创建一个模块测试-testmod" tabindex="-1"><a class="header-anchor" href="#_3-6-回到examples目录并创建一个模块测试-testmod"><span>3.6 回到examples目录并创建一个模块测试 testmod</span></a></h6><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 回到 examples 并创建 testmod 目录, 然后在进入 testmod 目录</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><h6 id="_3-7-testmod-模块中创建-main-go-文件" tabindex="-1"><a class="header-anchor" href="#_3-7-testmod-模块中创建-main-go-文件"><span>3.7 testmod 模块中创建 main.go 文件</span></a></h6><div class="language-go" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre></div><h6 id="_4-2-修改-hellomod-模块-hello-test-go-文件" tabindex="-1"><a class="header-anchor" href="#_4-2-修改-hellomod-模块-hello-test-go-文件"><span>4.2 修改 hellomod 模块 hello_test.go 文件</span></a></h6><div class="language-go" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token keyword">package</span> hellomod</span>
<span class="line"></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token string">&quot;testing&quot;</span></span>
<span class="line"></span>
...
<span class="line"> <span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre></div><h6 id="_4-3-提交-hellomod-模块代码" tabindex="-1"><a class="header-anchor" href="#_4-3-提交-hellomod-模块代码"><span>4.3 提交 hellomod 模块代码</span></a></h6><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> <span class="token function">add</span> <span class="token builtin class-name">.</span></span>
...
<span class="line"></span></code></pre></div><h6 id="_4-4-进入-testmod-模块目录-升级模块" tabindex="-1"><a class="header-anchor" href="#_4-4-进入-testmod-模块目录-升级模块"><span>4.4 进入 testmod 模块目录, 升级模块</span></a></h6><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token builtin class-name">cd</span> <span class="token punctuation">..</span>/ <span class="token operator">&amp;&amp;</span> <span class="token builtin class-name">cd</span> testmod</span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre></div><h6 id="_5-3-提交-hellomod-模块代码" tabindex="-1"><a class="header-anchor" href="#_5-3-提交-hellomod-模块代码"><span>5.3 提交 hellomod 模块代码</span></a></h6><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> checkout <span class="token parameter variable">-b</span> v3</span>
<span class="line"><span class="token function">git</span> <span class="token function">add</span> <span class="token builtin class-name">.</span></span>
...
<span class="line"><span class="token function">git</span> push origin master <span class="token parameter variable">--tags</span></span>
<span class="line"></span></code></pre></div><h6 id="_5-3-testmod-模块中修改-main-go-文件" tabindex="-1"><a class="header-anchor" href="#_5-3-testmod-模块中修改-main-go-文件"><span>5.3 testmod 模块中修改 main.go 文件</span></a></h6><div class="language-go" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token punctuation">(</span></span>
<span class="line"> <span class="token string">&quot;fmt&quot;</span></span>
<span class="line"> <span class="token string">&quot;github.com/qq1060656096/hellomod&quot;</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre></div><h6 id="_5-4-testmod-模块中执行命令-go-run-main-go" tabindex="-1"><a class="header-anchor" href="#_5-4-testmod-模块中执行命令-go-run-main-go"><span>5.4 testmod 模块中执行命令: go run main.go</span></a></h6><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token builtin class-name">cd</span> <span class="token punctuation">..</span>/ <span class="token operator">&amp;&amp;</span> <span class="token builtin class-name">cd</span> testmod</span>
...
<span class="line"></span></code></pre></div><p><strong>go run main.go执行结果</strong></p><div class="language-go" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line">$ <span class="token keyword">go</span> run main<span class="token punctuation">.</span><span class="token keyword">go</span>                                                 </span>
<span class="line">Hello World<span class="token operator">!</span></span>
...
<span class="line"></span></code></pre></div><h2 id="关于直接依赖和间接依赖" tabindex="-1"><a class="header-anchor" href="#关于直接依赖和间接依赖"><span>关于直接依赖和间接依赖</span></a></h2><p>比如开源软件 Kubernetes（v1.17.0版本）的 go.mod 文件中就有数十个依赖包被标记为<code>indirect</code>：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">require (</span>
...
<span class="line">)</span>
<span class="line"></span></code></pre></div><p>我们希望确定间接依赖<code>github.com/Rican7/retry v0.1.0 // indirect</code>是被哪个依赖引入的，则可以使用命令<code>go mod why</code>来查看：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">[root@ecs-d8b6 gomodule]# go mod why -m github.com/Rican7/retry</span>
