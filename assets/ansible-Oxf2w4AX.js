import{i as e,r as t,s as n,t as r}from"./app-Bmf6MlmU.js";var i=JSON.parse(`{"path":"/linux-tutor/linux-server/ansible.html","title":"Ansible 安装和配置","lang":"zh-CN","frontmatter":{"description":"Ansible 安装和配置 Ansible 说明 Ansible 官网：https://www.ansible.com/ Ansible 官网 Github：https://github.com/ansible/ansible Ansible 官网文档：https://docs.ansible.com// 简单讲：它的作用就是把写 shell 这件事变...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Ansible 安装和配置\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-07-15T12:37:10.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yzqdev\\",\\"url\\":\\"http://www.yzqdev.top\\"}]}"],["meta",{"property":"og:url","content":"https://yzqdev.github.io/cs-guide/cs-guide/linux-tutor/linux-server/ansible.html"}],["meta",{"property":"og:site_name","content":"cs-guide"}],["meta",{"property":"og:title","content":"Ansible 安装和配置"}],["meta",{"property":"og:description","content":"Ansible 安装和配置 Ansible 说明 Ansible 官网：https://www.ansible.com/ Ansible 官网 Github：https://github.com/ansible/ansible Ansible 官网文档：https://docs.ansible.com// 简单讲：它的作用就是把写 shell 这件事变..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-07-15T12:37:10.000Z"}],["meta",{"property":"article:modified_time","content":"2026-07-15T12:37:10.000Z"}]]},"git":{"createdTime":1653565176000,"updatedTime":1784119030000,"contributors":[{"name":"yzqdev","username":"yzqdev","email":"yzqdev@outlook.com","commits":3,"url":"https://github.com/yzqdev"}]},"readingTime":{"minutes":3.97,"words":1192},"filePathRelative":"linux-tutor/linux-server/ansible.md","autoDesc":true}`),a={name:`ansible.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="ansible-安装和配置" tabindex="-1"><a class="header-anchor" href="#ansible-安装和配置"><span>Ansible 安装和配置</span></a></h1><h2 id="ansible-说明" tabindex="-1"><a class="header-anchor" href="#ansible-说明"><span>Ansible 说明</span></a></h2><ul><li>Ansible 官网：<a href="https://www.ansible.com/" target="_blank" rel="noopener noreferrer">https://www.ansible.com/</a></li><li>Ansible 官网 Github：<a href="https://github.com/ansible/ansible" target="_blank" rel="noopener noreferrer">https://github.com/ansible/ansible</a></li><li>Ansible 官网文档：<a href="https://docs.ansible.com//" target="_blank" rel="noopener noreferrer">https://docs.ansible.com//</a></li><li>简单讲：它的作用就是把写 shell 这件事变成标准化、模块化。方便更好的自动化运维</li></ul><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><ul><li>官网说明：<a href="https://docs.ansible.com/ansible/latest/installation_guide/intro_installation.html" target="_blank" rel="noopener noreferrer">https://docs.ansible.com/ansible/latest/installation_guide/intro_installation.html</a></li><li>CentOS：<code>sudo yum install -y ansible</code><ul><li>查看版本：<code>ansible --version</code></li></ul></li></ul><hr><h2 id="配置基本概念" tabindex="-1"><a class="header-anchor" href="#配置基本概念"><span>配置基本概念</span></a></h2><h4 id="ansible-基本配置文件顺序" tabindex="-1"><a class="header-anchor" href="#ansible-基本配置文件顺序"><span>Ansible 基本配置文件顺序</span></a></h4><ul><li>Ansible 执行的时候会按照以下顺序查找配置项，所以修改的时候要特别注意改的是哪个文件</li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">ANSIBLE_CONFIG (环境变量)</span>
...
<span class="line">    - name: source profile</span>
<span class="line">      shell: source /etc/profile</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>执行命令：<code>ansible-playbook /opt/hadoop-playbook.yml</code></li></ul><hr><h2 id="参考" tabindex="-1"><a class="header-anchor" href="#参考"><span>参考</span></a></h2><ul><li><a href="https://www.jianshu.com/p/081139f73613" target="_blank" rel="noopener noreferrer">ANSIBLE模块 - shell和command区别</a></li><li><a href="https://www.the5fire.com/ansible-guide-cn.html" target="_blank" rel="noopener noreferrer">https://www.the5fire.com/ansible-guide-cn.html</a></li><li><a href="https://www.jianshu.com/p/62388a4fcbc6" target="_blank" rel="noopener noreferrer">https://www.jianshu.com/p/62388a4fcbc6</a></li><li><a href="http://showme.codes/2017-06-12/ansible-introduce/" target="_blank" rel="noopener noreferrer">http://showme.codes/2017-06-12/ansible-introduce/</a></li></ul>`,65)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};