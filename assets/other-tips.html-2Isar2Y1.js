...
<span class="line"></span>
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="git常用命令" tabindex="-1"><a class="header-anchor" href="#git常用命令"><span>Git常用命令</span></a></h3><h4 id="git-clone" tabindex="-1"><a class="header-anchor" href="#git-clone"><span>git clone</span></a></h4><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 将远程git仓库克隆到本地</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="git-config" tabindex="-1"><a class="header-anchor" href="#git-config"><span>git config</span></a></h4><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 配置git图形界面编码为utf-8</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><h4 id="git-remote" tabindex="-1"><a class="header-anchor" href="#git-remote"><span>git remote</span></a></h4><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 显示所有远程仓库</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><h4 id="git-add" tabindex="-1"><a class="header-anchor" href="#git-add"><span>git add</span></a></h4><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 添加所有的修改到Staging区</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="git-commit" tabindex="-1"><a class="header-anchor" href="#git-commit"><span>git commit</span></a></h4><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 提交Staging区的代码到本地仓库区</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><h4 id="git-branch" tabindex="-1"><a class="header-anchor" href="#git-branch"><span>git branch</span></a></h4><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 列出本地所有分支</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="git-checkout" tabindex="-1"><a class="header-anchor" href="#git-checkout"><span>git checkout</span></a></h4><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 创建本地分支并关联远程分支</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><h4 id="git-tag" tabindex="-1"><a class="header-anchor" href="#git-tag"><span>git tag</span></a></h4><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 创建带有说明的标签</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="git-diff" tabindex="-1"><a class="header-anchor" href="#git-diff"><span>git diff</span></a></h4><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 查看文件在工作区和暂存区区别</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><h4 id="git-show" tabindex="-1"><a class="header-anchor" href="#git-show"><span>git show</span></a></h4><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 查看指定标签的提交信息</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><h4 id="git-log" tabindex="-1"><a class="header-anchor" href="#git-log"><span>git log</span></a></h4><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 指定文件夹 log</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="git-rebase" tabindex="-1"><a class="header-anchor" href="#git-rebase"><span>git rebase</span></a></h4><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 将指定分支合并到当前分支</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><h4 id="git-restore" tabindex="-1"><a class="header-anchor" href="#git-restore"><span>git restore</span></a></h4><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 恢复第一次add 的文件，同 git rm --cached</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><h4 id="git-revert" tabindex="-1"><a class="header-anchor" href="#git-revert"><span>git revert</span></a></h4><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 撤销前一次commit</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><h2 id="git骚操作" tabindex="-1"><a class="header-anchor" href="#git骚操作"><span>Git骚操作</span></a></h2><h4 id="git命令不能自动补全-mac版" tabindex="-1"><a class="header-anchor" href="#git命令不能自动补全-mac版"><span>Git命令不能自动补全？（Mac版）</span></a></h4><blockquote><p>我见过有的人使用<code>Git</code>别名，反正因为有自动补全的存在，我从来没用过<code>Git</code>别名。不过我的确将我的<code>rm -rf</code>命令替换成了别的脚本了...</p></blockquote><p>安装<code>bash-completion</code></p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">brew install bash-completion</span>
<span class="line"></span></code></pre></div><p>添加 bash-completion 到<code>~/.bash_profile</code>:</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"> <span class="token keyword">if</span> <span class="token punctuation">[</span> <span class="token parameter variable">-f</span> <span class="token variable"><span class="token variable">$(</span>brew <span class="token parameter variable">--prefix</span><span class="token variable">)</span></span>/etc/bash_completion <span class="token punctuation">]</span><span class="token punctuation">;</span> <span class="token keyword">then</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><blockquote><p><code>shell</code>有不同种类，我这里使用的是<code>bash</code>。</p></blockquote><h4 id="代码没写完-突然要切换到别的分支怎么办" tabindex="-1"><a class="header-anchor" href="#代码没写完-突然要切换到别的分支怎么办"><span>代码没写完，突然要切换到别的分支怎么办？</span></a></h4><p>暂存未提交的代码</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> stash</span>
<span class="line"></span>
<span class="line"></span></code></pre></div><p>还原暂存的代码</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> stash apply</span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h4 id="怎么合并其他分支的指定commit" tabindex="-1"><a class="header-anchor" href="#怎么合并其他分支的指定commit"><span>怎么合并其他分支的指定Commit？</span></a></h4><p>使用<code>cherry-pick</code>命令</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> cherry-pick 指定commit-id</span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h4 id="本地临时代码不想提交-怎么一次性清空" tabindex="-1"><a class="header-anchor" href="#本地临时代码不想提交-怎么一次性清空"><span>本地临时代码不想提交，怎么一次性清空？</span></a></h4><p>还原未<code>commit</code>的本地更改的代码</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> reset <span class="token parameter variable">--hard</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><p>还原包含<code>commit</code>的代码，到跟远程分支相同</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> reset <span class="token parameter variable">--hard</span> origin/master</span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h4 id="已经提交的代码-不需要了-怎么当做没提交过" tabindex="-1"><a class="header-anchor" href="#已经提交的代码-不需要了-怎么当做没提交过"><span>已经提交的代码，不需要了，怎么当做没提交过？</span></a></h4><p>还原到上次<code>commit</code></p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> reset <span class="token parameter variable">--hard</span> HEAD^</span>
<span class="line"></span>
<span class="line"></span></code></pre></div><p>还原到当前之前的几次<code>commit</code></p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> reset <span class="token parameter variable">--hard</span> HEAD~2</span>
<span class="line"></span>
<span class="line"></span></code></pre></div><p>强制推送到远程分支，确保没有其他人在<code>push</code>，不然可能会丢失代码</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> push origin develop <span class="token parameter variable">--force</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>强制推送替换</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> push <span class="token parameter variable">--force</span> <span class="token parameter variable">--tags</span> origin <span class="token string">&#39;refs/heads/*&#39;</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h4 id="不小心把不该提交的文件commit了-怎么永久删除" tabindex="-1"><a class="header-anchor" href="#不小心把不该提交的文件commit了-怎么永久删除"><span>不小心把不该提交的文件commit了，怎么永久删除？</span></a></h4><p>也是使用<code>git filter-branch</code>命令。</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> filter-branch <span class="token parameter variable">--force</span> --index-filter <span class="token punctuation">\\</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><p>强制推送覆盖远程分支。</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> push origin <span class="token parameter variable">--force</span> <span class="token parameter variable">--all</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><p>强制推送覆盖远程<code>tag</code>。</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> push origin <span class="token parameter variable">--force</span> <span class="token parameter variable">--tags</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h3 id="删除文件" tabindex="-1"><a class="header-anchor" href="#删除文件"><span>删除文件</span></a></h3><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> filter-branch <span class="token parameter variable">--force</span> --index-filter <span class="token string">&#39;git rm --cached --ignore-unmatch walterlv.xml&#39;</span> --prune-empty --tag-name-filter <span class="token function">cat</span> -- <span class="token parameter variable">--all</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><p>我们可以在合并冲突后的任意时刻使用<code>git status</code>命令来查看那些因包含合并冲突而处于未合并<code>unmerged</code>状态的文件。</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">$ <span class="token function">git</span> status </span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><p>待解决冲突的文件<code>Git</code>会以未合并的状态标识出来，出现冲突的文件会出现一些特殊的区段，看起来像下面的样子。</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token operator">&lt;&lt;&lt;</span><span class="token operator">&lt;&lt;&lt;</span><span class="token operator">&lt;</span> HEAD</span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><p>然后，我们根据提示执行<code>git commit</code>。</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">Merge branch <span class="token string">&#39;dev&#39;</span></span>
<span class="line">  </span>
...
<span class="line">.git/objects/info</span>
<span class="line"></span>
<span class="line"></span></code></pre></div><p>我们发现<code>.git/objects</code>目录下，多了个文件和目录。实际上，<code>Git</code>会将我们的文件数据外加一个头部信息<code>header</code>一起做<code>SHA-1</code>校验运算而得到校验和。然后，校验和的前2个字符用于命名子目录，余下的38个字符则用作文件名。</p><p>我们可以使用下面的命令，显示在<code>Git</code>对象中存储的内容。</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">$ <span class="token function">git</span> cat-file <span class="token parameter variable">-p</span> 5f2f16bfff90e6620509c0cf442e7a3586dad8fb</span>
<span class="line"><span class="token number">1111</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><p>这就是我们在上文写入的文件内容。</p><p>上述类型的对象称之为<strong>数据对象（blob object）</strong>。数据对象，仅保存了文件内容，而文件名字没有被保存。</p><h3 id="树对象" tabindex="-1"><a class="header-anchor" href="#树对象"><span>树对象</span></a></h3><p>数据对象大致对应<code>UNIX</code>中的<code>inodes</code>或文件内容，树对象则对应了<code>UNIX</code>中的目录项。一个<strong>树对象</strong>包含了一条或多条<strong>树对象记录（tree entry）</strong>，每条记录含有一个指向数据对象或者子树对象的<code>SHA-1</code>指针，以及相应的模式、类型、文件名信息。</p><p>通常，<code>Git</code>根据某一时刻暂存区（即<code>index</code>区域）所表示的状态创建并记录一个对应的树对象。</p><p>当我们执行过<code>git add</code>之后，暂存区就有内容了，我们可以通过<code>Git</code>底层命令，生成树对象。</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">$ <span class="token function">git</span> write-tree</span>
<span class="line">b716c7b049ccd9048b0566a57cfd516c17c1e39f</span>
<span class="line"></span>
<span class="line"></span></code></pre></div><p>查看该树对象的内容。</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">$ <span class="token function">git</span> cat-file <span class="token parameter variable">-p</span> b716c7b049ccd9048b0566a57cfd516c17c1e39f</span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><h3 id="提交对象" tabindex="-1"><a class="header-anchor" href="#提交对象"><span>提交对象</span></a></h3><p>数据对象保存了数据的内容，树对象可以表示当前目录的快照。但是，若想重用这些快照，必须记住树对象的<code>SHA-1</code>哈希值。而且，我们也不知道是谁保存了这些快照，在什么时刻保存的，以及为什么保存这些快照。而以上这些，正是 <strong>提交对象（commit object）</strong> 能保存的基本信息。</p><p>我们对当前暂存区进行一次提交，<code>git commit -m &quot;first commit&quot;</code>。</p><p>然后查看一下<code>log</code>找到该次提交的<code>commit</code>哈希值。</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">$ <span class="token function">git</span> log <span class="token parameter variable">--oneline</span> </span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div><p>接着，我们查看一下该提交对象的内容。</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">$ <span class="token function">git</span> cat-file <span class="token parameter variable">-p</span> 5281f7e</span>
