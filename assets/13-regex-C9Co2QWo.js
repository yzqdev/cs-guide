...
<span class="line">(&#39;img&#39;, &#39;https://s-media-cache-ak0.pinimg.com/originals/a8/c4/9e/a8c49ef606e0e1f3ee39a7b219b5c05e.jpg&#39;)</span>
<span class="line"></span></code></pre></div><p>最后，正则表达式是非常厉害的工具，通常可以用来解决字符串内置函数无法解决的问题，而且正则表达式大部分语言都是有的。Python 的用途很多，但在爬虫和数据分析这两个模块中都是离不开正则表达式的。所以正则表达式对于学习 Python 来说非常重要。最后，附送一些常用的正则表达式和 Python 支持的正则表达式元字符和语法文档。</p><p>github：<a href="https://github.com/TwoWater/Python/blob/master/python14/%E5%B8%B8%E7%94%A8%E7%9A%84%E6%AD%A3%E5%88%99%E8%A1%A8%E8%BE%BE%E5%BC%8F.md" target="_blank" rel="noopener noreferrer">https://github.com/TwoWater/Python/blob/master/python14/常用的正则表达式.md</a></p><p>欢迎大家 star <a href="https://github.com/TwoWater/Python" target="_blank" rel="noopener noreferrer">https://github.com/TwoWater/Python</a>，这是草根学 Python 系列博客的库。</p><h1 id="常用的正则表达式" tabindex="-1"><a class="header-anchor" href="#常用的正则表达式"><span>常用的正则表达式</span></a></h1><h2 id="校验数字的表达式" tabindex="-1"><a class="header-anchor" href="#校验数字的表达式"><span>校验数字的表达式</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">1、  数字：^[0-9]*$</span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,101)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};