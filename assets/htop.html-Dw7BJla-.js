import{_ as a,c as e,a as n,o as t}from"./app-C8DxhDIZ.js";const i={};function l(p,s){return t(),e("div",null,s[0]||(s[0]=[n(`<h1 id="htop工具" tabindex="-1"><a class="header-anchor" href="#htop工具"><span>htop工具</span></a></h1><p>top命令是Linux下常用的性能分析工具，能够实时显示系统中各个进程的资源占用状况，类似于Windows的任务管理器。top是一个动态显示过程,即可以通过用户按键来不断刷新当前状态.如果在前台执行该命令,它将独占前台,直到用户终止该程序为止.比较准确的说,top命令提供了实时的对系统处理器的状态监视.它将显示系统中CPU最“敏感”的任务列表.该命令可以按CPU使用.内存使用和执行时间对任务进行排序；而且该命令的很多特性都可以通过交互式命令或者在个人定制文件中进行设定。<br> 常在linux系统下玩，这是必须掌握的命令之一； 下面详细说说这个命令：</p><p>敲入top进入：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">top - 09:14:56 up 264 days, 20:56,  1 user,  load average: 0.02, 0.04, 0.00</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注：强调一下，使用频率最高的是P、T、M，因为通常使用top，我们就想看看是哪些进程最耗cpu资源、占用的内存最多； 注：通过”shift + &gt;”或”shift + &lt;”可以向右或左改变排序列 如果只需要查看内存：可用free命令。只查看uptime信息（第一行），可用uptime命令；</p><h2 id="实例" tabindex="-1"><a class="header-anchor" href="#实例"><span>实例</span></a></h2><h3 id="实例1-多u多核cpu监控" tabindex="-1"><a class="header-anchor" href="#实例1-多u多核cpu监控"><span>实例1：多U多核CPU监控</span></a></h3><p>在top基本视图中，按键盘数字“1”，可监控每个逻辑CPU的状况；</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">[rdtfr@bl685cb4-t ~]$ top</span>
...
<span class="line"></span></code></pre></div><h3 id="实例2-高亮显示当前运行进程" tabindex="-1"><a class="header-anchor" href="#实例2-高亮显示当前运行进程"><span>实例2：高亮显示当前运行进程</span></a></h3><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">在top基本视图中,按键盘“b”（打开/关闭加亮效果）；</span>
<span class="line"></span></code></pre></div><h3 id="实例3-显示完整的程序命令" tabindex="-1"><a class="header-anchor" href="#实例3-显示完整的程序命令"><span>实例3：显示完整的程序命令</span></a></h3><p>命令：top -c</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">[rdtfr@bl685cb4-t ~]$ top -c</span>
...
<span class="line"></span></code></pre></div><h3 id="实例4-显示指定的进程信息" tabindex="-1"><a class="header-anchor" href="#实例4-显示指定的进程信息"><span>实例4：显示指定的进程信息</span></a></h3><p>命令：top -p pidid</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">/opt/app/tdv1/config#top -p 17265</span>
