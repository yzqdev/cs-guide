...
<span class="line"></span></code></pre></div><h2 id="_6、后台线程" tabindex="-1"><a class="header-anchor" href="#_6、后台线程"><span>6、后台线程</span></a></h2><p>默认情况下，主线程退出之后，即使子线程没有 join。那么主线程结束后，子线程也依然会继续执行。如果希望主线程退出后，其子线程也退出而不再执行，则需要设置子线程为后台线程。Python 提供了 <code>setDeamon</code> 方法。</p>`,63)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};