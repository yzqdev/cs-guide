import{_ as e,o as t,c as s,a as n}from"./app-BO2oONDQ.js";const i={},l=n(`<h1 id="网络工具" tabindex="-1"><a class="header-anchor" href="#网络工具"><span>网络工具</span></a></h1><h2 id="查询网络服务和端口" tabindex="-1"><a class="header-anchor" href="#查询网络服务和端口"><span>查询网络服务和端口</span></a></h2><p>netstat 命令用于显示各种网络相关信息，如网络连接，路由表，接口状态 (Interface Statistics)，masquerade 连接，多播成员 (Multicast Memberships) 等等。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>列出所有端口 (包括监听和未监听的):
