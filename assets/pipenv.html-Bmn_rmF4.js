import{_ as s,c as a,a as e,o as p}from"./app-Die-Lcms.js";const i={};function l(t,n){return p(),a("div",null,n[0]||(n[0]=[e(`<h1 id="pipenv使用" tabindex="-1"><a class="header-anchor" href="#pipenv使用"><span>pipenv使用</span></a></h1><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><p>安装python <a href="https://registry.npmmirror.com/binary.html?path=python/" target="_blank" rel="noopener noreferrer">安装包</a><br> windows安装后会自动吧pip和python加入到环境变量</p><h2 id="安装pipenv" tabindex="-1"><a class="header-anchor" href="#安装pipenv"><span>安装pipenv</span></a></h2><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">pip <span class="token function">install</span> pipenv </span>
...
<span class="line"></span></code></pre></div><h2 id="使用pipenv" tabindex="-1"><a class="header-anchor" href="#使用pipenv"><span>使用pipenv</span></a></h2><div class="language-txt" data-highlighter="prismjs" data-ext="txt" data-title="txt"><pre><code><span class="line">添加镜像</span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><div class="language-toml" data-highlighter="prismjs" data-ext="toml" data-title="toml"><pre><code><span class="line"><span class="token punctuation">[</span><span class="token punctuation">[</span><span class="token table class-name">source</span><span class="token punctuation">]</span><span class="token punctuation">]</span></span>
...
<span class="line"></span></code></pre></div><div class="language-toml" data-highlighter="prismjs" data-ext="toml" data-title="toml"><pre><code><span class="line"><span class="token punctuation">[</span><span class="token table class-name">global</span><span class="token punctuation">]</span></span>
...
<span class="line"></span></code></pre></div><p>默认安装的虚拟环境都在c盘<code>%userprofile%的.virtualenvs</code>文件夹下面,如果想更换,可以添加<code>PIPENV_VENV_IN_PROJECT</code>环境变量,并设置值为<code>1</code>,就是在项目下面创建虚拟环境</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 创建一个env环境</span></span>
