import{_ as t,c as e,o as n,d as o}from"./app-CbULZrmi.js";const i={},s=o(`<h1 id="nodejs教程" tabindex="-1"><a class="header-anchor" href="#nodejs教程"><span>nodejs教程</span></a></h1><h2 id="遍历文件夹并生成标题" tabindex="-1"><a class="header-anchor" href="#遍历文件夹并生成标题"><span>遍历文件夹并生成标题</span></a></h2><pre><code class="language-js">//getFiles.js
import fs from &quot;fs&quot;;
...
</code></pre>`,21),l=[s];function a(r,u){return n(),e("div",null,l)}const c=t(i,[["render",a],["__file","nodejs-tutor.html.vue"]]),f=JSON.parse('{"path":"/node-tutor/node-snippets/nodejs-tutor.html","title":"nodejs教程","lang":"zh-CN","frontmatter":{"description":"nodejs教程 遍历文件夹并生成标题 提示 生成 遍历文件夹里面的markdown 提示 输出 深层次遍历文件夹并输出markdown标题 提示 生成 获取一个文件夹所有的md文件 提示 输出 批量rst文件转为md文件 在每个文件夹里都生成一个README.md文件(.vuepress文件夹除外) 循环遍历文件夹,并输出文件内容 把md文件里面的所...","head":[["meta",{"property":"og:url","content":"https://yzqdev.github.io/cs-guide/cs-guide/node-tutor/node-snippets/nodejs-tutor.html"}],["meta",{"property":"og:site_name","content":"cs-guide"}],["meta",{"property":"og:title","content":"nodejs教程"}],["meta",{"property":"og:description","content":"nodejs教程 遍历文件夹并生成标题 提示 生成 遍历文件夹里面的markdown 提示 输出 深层次遍历文件夹并输出markdown标题 提示 生成 获取一个文件夹所有的md文件 提示 输出 批量rst文件转为md文件 在每个文件夹里都生成一个README.md文件(.vuepress文件夹除外) 循环遍历文件夹,并输出文件内容 把md文件里面的所..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2023-06-25T05:00:38.000Z"}],["meta",{"property":"article:author","content":"yzqdev"}],["meta",{"property":"article:modified_time","content":"2023-06-25T05:00:38.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"nodejs教程\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2023-06-25T05:00:38.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yzqdev\\",\\"url\\":\\"http://www.yzqdev.top\\"}]}"]]},"headers":[{"level":2,"title":"遍历文件夹并生成标题","slug":"遍历文件夹并生成标题","link":"#遍历文件夹并生成标题","children":[]},{"level":2,"title":"遍历文件夹里面的markdown","slug":"遍历文件夹里面的markdown","link":"#遍历文件夹里面的markdown","children":[]},{"level":2,"title":"深层次遍历文件夹并输出markdown标题","slug":"深层次遍历文件夹并输出markdown标题","link":"#深层次遍历文件夹并输出markdown标题","children":[]},{"level":2,"title":"获取一个文件夹所有的md文件","slug":"获取一个文件夹所有的md文件","link":"#获取一个文件夹所有的md文件","children":[]},{"level":2,"title":"批量rst文件转为md文件","slug":"批量rst文件转为md文件","link":"#批量rst文件转为md文件","children":[]},{"level":2,"title":"在每个文件夹里都生成一个README.md文件(.vuepress文件夹除外)","slug":"在每个文件夹里都生成一个readme-md文件-vuepress文件夹除外","link":"#在每个文件夹里都生成一个readme-md文件-vuepress文件夹除外","children":[]},{"level":2,"title":"循环遍历文件夹,并输出文件内容","slug":"循环遍历文件夹-并输出文件内容","link":"#循环遍历文件夹-并输出文件内容","children":[]},{"level":2,"title":"把md文件里面的所有在线图片下载到res文件夹,并替换原来的md文件","slug":"把md文件里面的所有在线图片下载到res文件夹-并替换原来的md文件","link":"#把md文件里面的所有在线图片下载到res文件夹-并替换原来的md文件","children":[]}],"git":{"createdTime":1684989246000,"updatedTime":1687669238000,"contributors":[{"name":"yzqdev","email":"yzqdev@outlook.com","commits":1}]},"readingTime":{"minutes":5.64,"words":1691},"filePathRelative":"node-tutor/node-snippets/nodejs-tutor.md","localizedDate":"2023年5月25日","autoDesc":true}');export{c as comp,f as data};
