import{_ as p,c as i,a as e,d as t,b as s,w as c,t as o,e as n,r as u,o as r}from"./app-BKQjDlOh.js";const d={};function v(m,a){const l=u("CodeDemo");return r(),i("div",null,[a[4]||(a[4]=e(`<h1 id="vue-渐进式javascript框架" tabindex="-1"><a class="header-anchor" href="#vue-渐进式javascript框架"><span>Vue -渐进式JavaScript框架</span></a></h1><h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍"><span>介绍</span></a></h2><ul><li><a href="https://cn.vuejs.org/" target="_blank" rel="noopener noreferrer">vue2官网</a> (<a href="https://vuejs.org/" target="_blank" rel="noopener noreferrer">vue3在这里</a>)</li><li><a href="https://router.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">vue-rotuer官网</a></li><li><a href="https://vuex.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">vuex官网</a></li><li><a href="https://devtools.vuejs.org/" target="_blank" rel="noopener noreferrer">vue调试工具(必装,需要科学上网)</a></li><li><a href="https://github.com/vuejs/awesome-vue" target="_blank" rel="noopener noreferrer">vue组件大全</a></li><li><a href="https://cli.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">vue-cli开发工具</a></li><li><a href="https://cn.vitejs.dev/" target="_blank" rel="noopener noreferrer">vite开发工具</a></li><li><a href="https://ssr.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">vue-ssr官网</a></li><li><a href="https://nuxtjs.org/" target="_blank" rel="noopener noreferrer">nuxtjs官网</a>(实现vuessr,快速搭建平台)</li><li>Vue.js 是一套构建用户界面(UI)的渐进式JavaScript框架</li></ul><h3 id="学习vue要转化思想" tabindex="-1"><a class="header-anchor" href="#学习vue要转化思想"><span>学习Vue要转化思想</span></a></h3><ul><li>不要在想着怎么操作DOM(jquery思想)，而是想着如何操作数据！！！</li></ul><h2 id="起步-hello-vue" tabindex="-1"><a class="header-anchor" href="#起步-hello-vue"><span>起步 - Hello Vue</span></a></h2><h3 id="使用vue-cli工具" tabindex="-1"><a class="header-anchor" href="#使用vue-cli工具"><span>使用vue-cli工具</span></a></h3><ul><li>安装：<code>npm i -g @vue/cli</code></li></ul><blockquote><p>vue-cli是什么? Vue CLI 是一个基于 Vue.js 进行快速开发的完整系统，提供：</p></blockquote><p>通过 @vue/cli 搭建交互式的项目脚手架。 通过 @vue/cli + @vue/cli-service-global 快速开始零配置原型开发。 一个运行时依赖 (@vue/cli-service)，该依赖：</p><ul><li><p>可升级；</p></li><li><p>基于 webpack 构建，并带有合理的默认配置；</p></li><li><p>可以通过项目内的配置文件进行配置；</p></li><li><p>可以通过插件进行扩展。</p></li><li><p>一个丰富的官方插件集合，集成了前端生态中最好的工具。</p></li><li><p>一套完全图形化的创建和管理 Vue.js 项目的用户界面。</p></li><li></li></ul><blockquote><p>如何使用?</p></blockquote><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">//创建一个项目</span>
