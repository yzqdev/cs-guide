...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="安装-1" tabindex="-1"><a class="header-anchor" href="#安装-1"><span>安装</span></a></h3><ul><li>先确定本机安装过 MySQL</li><li>并且安装过：<code>yum install mysql-devel</code></li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>git clone https://github.com/Percona-Lab/tpcc-mysql
cd tpcc-mysql/src
make
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="测试的几个表介绍" tabindex="-1"><a class="header-anchor" href="#测试的几个表介绍"><span>测试的几个表介绍</span></a></h3><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>tpcc-mysql的业务逻辑及其相关的几个表作用如下：
...
商品：主要对应item表
仓库：主要对应warehouse表
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="准备" tabindex="-1"><a class="header-anchor" href="#准备"><span>准备</span></a></h3><ul><li>测试阿里云 ECS 与 RDS 是否相通：</li><li>记得在 RDS 添加账号和给账号配置权限，包括：配置权限、数据权限（默认添加账号后都是没有开启的，还要自己手动开启）</li><li>还要添加内网 ECS 到 RDS 的白名单 IP 里面</li><li>或者在 RDS 上开启外网访问设置，但是也设置 IP 白名单（访问 ip.cn 查看自己的外网 IP 地址，比如：120.85.112.97）</li><li>RDS 的内网地址和外网地址不一样，要认真看。</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>ping rm-wz9v0vej02ys79jbj.mysql.rds.aliyuncs.com

mysql -h rm-wz9v0vej02ys79jbj.mysql.rds.aliyuncs.com -P 3306 -u myaccount -p

输入密码：Aa123456
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>创库，名字为：TPCC：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="测试" tabindex="-1"><a class="header-anchor" href="#测试"><span>测试</span></a></h3><ul><li><p>数据库：阿里云 RDS-MySQL-5.7-2C4G</p></li><li><p>测试机：阿里云 ECS-4C4G-CentOS7.6</p></li><li><p>根据测试，不同的 ECS 测试机，不同的 RDS 测试结果有时候差距挺大的，这个很蛋疼。</p></li><li><p>需要注意的是 tpcc 默认会读取 /var/lib/mysql/mysql.sock 这个 socket 文件。因此，如果你的socket文件不在相应路径的话，可以做个软连接，或者通过TCP/IP的方式连接测试服务器</p></li><li><p>准备数据：</p></li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>cd /opt/tpcc-mysql
...
select count(*) from warehouse;
    80
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>开始测试：</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="报表" tabindex="-1"><a class="header-anchor" href="#报表"><span>报表</span></a></h3><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>&lt;TpmC&gt;
188.000 TpmC
TpmC结果值(每分钟事务数，该值是第一次统计结果中的新订单事务数除以总耗时分钟数，例如本例中是：372/2=186)
tpmC值在国内外被广泛用于衡量计算机系统的事务处理能力
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>RDS-2C4G-80个仓库结果：</li><li>CPU：100%，内存：34%，连接数：17%，IOPS：62%，磁盘空间：20G</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>1780, trx: 979, 95%: 1849.535, 99%: 2402.613, max_rt: 3401.947, 986|3248.772, 98|698.821, 103|4202.110, 101|4547.416
...
&lt;TpmC&gt;
                 5812.667 TpmC
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>升级：RDS-4C8G-80个仓库结果</li><li>CPU：100%，内存：55%，连接数：10%，IOPS：20%，磁盘空间：25G</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>1780, trx: 2303, 95%: 796.121, 99%: 1099.640, max_rt: 1596.883, 2293|2249.288, 232|256.393, 230|1694.050, 235|2550.775
...
&lt;TpmC&gt;
                 13552.467 TpmC
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>升级：RDS-8C16G-80个仓库结果</li><li>CPU：100%，内存：35%，连接数：5%，IOPS：18%，磁盘空间：30G</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>1780, trx: 4502, 95%: 398.131, 99%: 501.634, max_rt: 772.128, 4473|740.073, 446|183.361, 448|1042.264, 442|1302.569
...
&lt;TpmC&gt;
                 26791.934 TpmC
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>升级：RDS-16C64G-80个仓库结果</li><li>CPU：100%，内存：18%，连接数：2%，IOPS：10%，磁盘空间：40G</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>1780, trx: 8413, 95%: 203.560, 99%: 279.322, max_rt: 451.010, 8414|441.849, 841|92.900, 839|583.340, 843|644.276
...
&lt;TpmC&gt;
                 51097.668 TpmC
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>几轮下来，最终数据量：</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>select count(*) from customer;
    2400000
select count(*) from district;
    800    
select count(*) from history;
...
select count(*) from warehouse;
    80
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="资料" tabindex="-1"><a class="header-anchor" href="#资料"><span>资料</span></a></h2>`,28),C={href:"https://my.oschina.net/moooofly/blog/152547",target:"_blank",rel:"noopener noreferrer"},w={href:"http://www.techug.com/post/mysql-mysqlslap.html",target:"_blank",rel:"noopener noreferrer"},T={href:"http://jixiuf.github.io/blog/mysql%E5%8E%8B%E5%8A%9B%E6%B5%8B%E8%AF%95/",target:"_blank",rel:"noopener noreferrer"},O={href:"http://blog.chinaunix.net/uid-25723371-id-3498970.html",target:"_blank",rel:"noopener noreferrer"},L={href:"http://nsimple.top/archives/mysql-sysbench-tool.html",target:"_blank",rel:"noopener noreferrer"},R={href:"https://dearhwj.gitbooks.io/itbook/content/test/performance_test_qps_tps.html",target:"_blank",rel:"noopener noreferrer"},X={href:"https://www.hi-linux.com/posts/38534.html",target:"_blank",rel:"noopener noreferrer"};function Q(G,N){const s=r("ExternalLinkIcon");return a(),d("div",null,[o,u,e("ul",null,[e("li",null,[l("工具的官网说明："),e("a",v,[l("https://dev.mysql.com/doc/refman/5.5/en/mysqlslap.html"),n(s)])]),m]),b,e("ul",null,[e("li",null,[l("工具的官网说明："),e("a",p,[l("https://launchpad.net/sysbench"),n(s)])]),e("li",null,[l("开源地址："),e("a",h,[l("https://github.com/akopytov/sysbench"),n(s)])])]),y,e("ul",null,[g,q,e("li",null,[l("下载："),e("a",f,[l("https://github.com/akopytov/sysbench/releases"),n(s)])]),_]),x,e("ul",null,[S,e("li",null,[l("官网主页："),e("a",P,[l("https://github.com/Percona-Lab/tpcc-mysql"),n(s)])])]),k,e("ul",null,[e("li",null,[e("a",C,[l("https://my.oschina.net/moooofly/blog/152547"),n(s)])]),e("li",null,[e("a",w,[l("http://www.techug.com/post/mysql-mysqlslap.html"),n(s)])]),e("li",null,[e("a",T,[l("http://jixiuf.github.io/blog/mysql压力测试/"),n(s)])]),e("li",null,[e("a",O,[l("http://blog.chinaunix.net/uid-25723371-id-3498970.html"),n(s)])]),e("li",null,[e("a",L,[l("http://nsimple.top/archives/mysql-sysbench-tool.html"),n(s)])]),e("li",null,[e("a",R,[l("https://dearhwj.gitbooks.io/itbook/content/test/performance_test_qps_tps.html"),n(s)])]),e("li",null,[e("a",X,[l("https://www.hi-linux.com/posts/38534.html"),n(s)])])])])}const M=t(c,[["render",Q],["__file","Mysql-Test.html.vue"]]),D=JSON.parse(`{"path":"/linux-tutor/server/Mysql-Test.html","title":"MySQL 测试","lang":"zh-CN","frontmatter":{"description":"MySQL 测试 mysqlslap 工具 工具的官网说明：https://dev.mysql.com/doc/refman/5.5/en/mysqlslap.html 可能会遇到的报错： 报：mysqlslap: Error when connecting to server: Can't connect to local MySQL server ...","head":[["meta",{"property":"og:url","content":"https://yzqdev.github.io/cs-guide/cs-guide/linux-tutor/server/Mysql-Test.html"}],["meta",{"property":"og:site_name","content":"cs-guide"}],["meta",{"property":"og:title","content":"MySQL 测试"}],["meta",{"property":"og:description","content":"MySQL 测试 mysqlslap 工具 工具的官网说明：https://dev.mysql.com/doc/refman/5.5/en/mysqlslap.html 可能会遇到的报错： 报：mysqlslap: Error when connecting to server: Can't connect to local MySQL server ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2022-05-27T01:37:35.000Z"}],["meta",{"property":"article:author","content":"yzqdev"}],["meta",{"property":"article:modified_time","content":"2022-05-27T01:37:35.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"MySQL 测试\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2022-05-27T01:37:35.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yzqdev\\",\\"url\\":\\"http://www.yzqdev.top\\"}]}"]]},"headers":[{"level":2,"title":"mysqlslap 工具","slug":"mysqlslap-工具","link":"#mysqlslap-工具","children":[{"level":3,"title":"进行基准测试：","slug":"进行基准测试","link":"#进行基准测试","children":[]},{"level":3,"title":"测试结果含义解释：","slug":"测试结果含义解释","link":"#测试结果含义解释","children":[]},{"level":3,"title":"对自己的数据库进行测试：","slug":"对自己的数据库进行测试","link":"#对自己的数据库进行测试","children":[]},{"level":3,"title":"其他一些参数：","slug":"其他一些参数","link":"#其他一些参数","children":[]}]},{"level":2,"title":"sysbench 工具","slug":"sysbench-工具","link":"#sysbench-工具","children":[{"level":3,"title":"安装","slug":"安装","link":"#安装","children":[]},{"level":3,"title":"开始测试","slug":"开始测试","link":"#开始测试","children":[]},{"level":3,"title":"测试报告","slug":"测试报告","link":"#测试报告","children":[]}]},{"level":2,"title":"QPS 和 TPS 和说明","slug":"qps-和-tps-和说明","link":"#qps-和-tps-和说明","children":[{"level":3,"title":"基本概念","slug":"基本概念","link":"#基本概念","children":[]},{"level":3,"title":"QPS、TPS和性能的关系","slug":"qps、tps和性能的关系","link":"#qps、tps和性能的关系","children":[]},{"level":3,"title":"结论","slug":"结论","link":"#结论","children":[]}]},{"level":2,"title":"Percona TPCC-MySQL 测试工具（优先推荐）","slug":"percona-tpcc-mysql-测试工具-优先推荐","link":"#percona-tpcc-mysql-测试工具-优先推荐","children":[{"level":3,"title":"安装","slug":"安装-1","link":"#安装-1","children":[]},{"level":3,"title":"测试的几个表介绍","slug":"测试的几个表介绍","link":"#测试的几个表介绍","children":[]},{"level":3,"title":"准备","slug":"准备","link":"#准备","children":[]},{"level":3,"title":"测试","slug":"测试","link":"#测试","children":[]},{"level":3,"title":"报表","slug":"报表","link":"#报表","children":[]}]},{"level":2,"title":"资料","slug":"资料","link":"#资料","children":[]}],"git":{"createdTime":1653615455000,"updatedTime":1653615455000,"contributors":[{"name":"yzqdev","email":"yzqdev@outlook.com","commits":1}]},"readingTime":{"minutes":16.36,"words":4907},"filePathRelative":"linux-tutor/server/Mysql-Test.md","localizedDate":"2022年5月27日","autoDesc":true}`);export{M as comp,D as data};
