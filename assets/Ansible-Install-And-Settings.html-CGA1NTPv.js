import{_ as n,c as e,a as l,o as a}from"./app-Dd1lYWPM.js";const i={};function d(t,s){return a(),e("div",null,s[0]||(s[0]=[l(`<h1 id="ansible-安装和配置" tabindex="-1"><a class="header-anchor" href="#ansible-安装和配置"><span>Ansible 安装和配置</span></a></h1><h2 id="ansible-说明" tabindex="-1"><a class="header-anchor" href="#ansible-说明"><span>Ansible 说明</span></a></h2><ul><li>Ansible 官网：<a href="https://www.ansible.com/" target="_blank" rel="noopener noreferrer">https://www.ansible.com/</a></li><li>Ansible 官网 Github：<a href="https://github.com/ansible/ansible" target="_blank" rel="noopener noreferrer">https://github.com/ansible/ansible</a></li><li>Ansible 官网文档：<a href="https://docs.ansible.com//" target="_blank" rel="noopener noreferrer">https://docs.ansible.com//</a></li><li>简单讲：它的作用就是把写 shell 这件事变成标准化、模块化。方便更好的自动化运维</li></ul><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><ul><li>官网说明：<a href="https://docs.ansible.com/ansible/latest/installation_guide/intro_installation.html" target="_blank" rel="noopener noreferrer">https://docs.ansible.com/ansible/latest/installation_guide/intro_installation.html</a></li><li>CentOS：<code>sudo yum install -y ansible</code><ul><li>查看版本：<code>ansible --version</code></li></ul></li></ul><hr><h2 id="配置基本概念" tabindex="-1"><a class="header-anchor" href="#配置基本概念"><span>配置基本概念</span></a></h2><h4 id="ansible-基本配置文件顺序" tabindex="-1"><a class="header-anchor" href="#ansible-基本配置文件顺序"><span>Ansible 基本配置文件顺序</span></a></h4><ul><li>Ansible 执行的时候会按照以下顺序查找配置项，所以修改的时候要特别注意改的是哪个文件</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">ANSIBLE_CONFIG (环境变量)</span>
