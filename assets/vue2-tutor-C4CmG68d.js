import{a as e,c as t,f as n,i as r,l as i,n as a,o,r as s,s as c,t as l}from"./app-B3WoL9pX.js";var u=JSON.parse(`{"path":"/frontend/framework/vue/vue2-tutor.html","title":"Vue -渐进式JavaScript框架","lang":"zh-CN","frontmatter":{"order":1,"description":"Vue -渐进式JavaScript框架 介绍 vue2官网 (vue3在这里) vue-rotuer官网 vuex官网 vue调试工具(必装,需要科学上网) vue组件大全 vue-cli开发工具 vite开发工具 vue-ssr官网 nuxtjs官网(实现vuessr,快速搭建平台) Vue.js 是一套构建用户界面(UI)的渐进式JavaScri...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Vue -渐进式JavaScript框架\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2023-06-25T05:00:38.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yzqdev\\",\\"url\\":\\"http://www.yzqdev.top\\"}]}"],["meta",{"property":"og:url","content":"https://yzqdev.github.io/cs-guide/cs-guide/frontend/framework/vue/vue2-tutor.html"}],["meta",{"property":"og:site_name","content":"cs-guide"}],["meta",{"property":"og:title","content":"Vue -渐进式JavaScript框架"}],["meta",{"property":"og:description","content":"Vue -渐进式JavaScript框架 介绍 vue2官网 (vue3在这里) vue-rotuer官网 vuex官网 vue调试工具(必装,需要科学上网) vue组件大全 vue-cli开发工具 vite开发工具 vue-ssr官网 nuxtjs官网(实现vuessr,快速搭建平台) Vue.js 是一套构建用户界面(UI)的渐进式JavaScri..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2023-06-25T05:00:38.000Z"}],["meta",{"property":"article:modified_time","content":"2023-06-25T05:00:38.000Z"}]]},"git":{"createdTime":1647861419000,"updatedTime":1687669238000,"contributors":[{"name":"yzqdev","username":"yzqdev","email":"yzqdev@outlook.com","commits":8,"url":"https://github.com/yzqdev"}]},"readingTime":{"minutes":28.15,"words":8446},"filePathRelative":"frontend/framework/vue/vue2-tutor.md","autoDesc":true}`),d={name:`vue2-tutor.md`};function f(l,u,d,f,p,m){let h=t(`CodeDemo`);return c(),s(`div`,null,[u[4]||=r(`<h1 id="vue-渐进式javascript框架" tabindex="-1"><a class="header-anchor" href="#vue-渐进式javascript框架"><span>Vue -渐进式JavaScript框架</span></a></h1><h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍"><span>介绍</span></a></h2><ul><li><a href="https://cn.vuejs.org/" target="_blank" rel="noopener noreferrer">vue2官网</a> (<a href="https://vuejs.org/" target="_blank" rel="noopener noreferrer">vue3在这里</a>)</li><li><a href="https://router.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">vue-rotuer官网</a></li><li><a href="https://vuex.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">vuex官网</a></li><li><a href="https://devtools.vuejs.org/" target="_blank" rel="noopener noreferrer">vue调试工具(必装,需要科学上网)</a></li><li><a href="https://github.com/vuejs/awesome-vue" target="_blank" rel="noopener noreferrer">vue组件大全</a></li><li><a href="https://cli.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">vue-cli开发工具</a></li><li><a href="https://cn.vitejs.dev/" target="_blank" rel="noopener noreferrer">vite开发工具</a></li><li><a href="https://ssr.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">vue-ssr官网</a></li><li><a href="https://nuxtjs.org/" target="_blank" rel="noopener noreferrer">nuxtjs官网</a>(实现vuessr,快速搭建平台)</li><li>Vue.js 是一套构建用户界面(UI)的渐进式JavaScript框架</li></ul><h3 id="学习vue要转化思想" tabindex="-1"><a class="header-anchor" href="#学习vue要转化思想"><span>学习Vue要转化思想</span></a></h3><ul><li>不要在想着怎么操作DOM(jquery思想)，而是想着如何操作数据！！！</li></ul><h2 id="起步-hello-vue" tabindex="-1"><a class="header-anchor" href="#起步-hello-vue"><span>起步 - Hello Vue</span></a></h2><h3 id="使用vue-cli工具" tabindex="-1"><a class="header-anchor" href="#使用vue-cli工具"><span>使用vue-cli工具</span></a></h3><ul><li>安装：<code>npm i -g @vue/cli</code></li></ul><blockquote><p>vue-cli是什么? Vue CLI 是一个基于 Vue.js 进行快速开发的完整系统，提供：</p></blockquote><p>通过 @vue/cli 搭建交互式的项目脚手架。 通过 @vue/cli + @vue/cli-service-global 快速开始零配置原型开发。 一个运行时依赖 (@vue/cli-service)，该依赖：</p><ul><li><p>可升级；</p></li><li><p>基于 webpack 构建，并带有合理的默认配置；</p></li><li><p>可以通过项目内的配置文件进行配置；</p></li><li><p>可以通过插件进行扩展。</p></li><li><p>一个丰富的官方插件集合，集成了前端生态中最好的工具。</p></li><li><p>一套完全图形化的创建和管理 Vue.js 项目的用户界面。</p></li><li></li></ul><blockquote><p>如何使用?</p></blockquote><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">//创建一个项目</span>
...
<span class="line"></span></code></pre></div><div class="hint-container tip"><p class="hint-container-title">提示</p><p>推荐使用vue官网的sfc工具 ,<a href="https://sfc.vuejs.org/#" target="_blank" rel="noopener noreferrer">链接</a></p></div><p>创建一个hellowold程序</p>`,22),o(h,{id:`code-demo-154`,type:`vue`,code:`eJxNjkEOgyAQRa8yYaMmTd1T9CRsqNDWZBQCo7Uh3L2gpunuz8z7LxPZuhjGmSAzOVRkejkDCD2uMKAKoZPsbjfJ9vVx6GOcwjMl0ZZhx88k2j+LCIMfHeVkNmc9gTYPtSBBLBWtSHGoG+h6qCNkIa9eBtHC23rUFaTmUjg5p1sR/2Qi0AeL/5r/guDUfAgHi9Zz8EZnPu2VE8wOlr7fuk9t`},{default:i(()=>[...u[0]||=[a(`div`,{class:`language-vue line-numbers-mode`,"data-highlighter":`prismjs`,"data-ext":`vue`},[a(`pre`,null,[a(`code`,{class:`language-vue`},[a(`span`,{class:`line`},[a(`span`,{class:`token tag`},[a(`span`,{class:`token tag`},[a(`span`,{class:`token punctuation`},`<`),e(`template`)]),a(`span`,{class:`token punctuation`},`>`)])]),e(`
`),a(`span`,{class:`line`},[e(`  `),a(`span`,{class:`token tag`},[a(`span`,{class:`token tag`},[a(`span`,{class:`token punctuation`},`<`),e(`div`)]),e(),a(`span`,{class:`token attr-name`},`class`),a(`span`,{class:`token attr-value`},[a(`span`,{class:`token punctuation attr-equals`},`=`),a(`span`,{class:`token punctuation`},`"`),e(`box`),a(`span`,{class:`token punctuation`},`"`)]),a(`span`,{class:`token punctuation`},`>`)])]),e(`
`),a(`span`,{class:`line`},[e(`    `),a(`span`,{class:`token tag`},[a(`span`,{class:`token tag`},[a(`span`,{class:`token punctuation`},`<`),e(`div`)]),a(`span`,{class:`token punctuation`},`>`)]),e(`{{msg}}`),a(`span`,{class:`token tag`},[a(`span`,{class:`token tag`},[a(`span`,{class:`token punctuation`},`</`),e(`div`)]),a(`span`,{class:`token punctuation`},`>`)])]),e(`
`),a(`span`,{class:`line`},[e(`  `),a(`span`,{class:`token tag`},[a(`span`,{class:`token tag`},[a(`span`,{class:`token punctuation`},`</`),e(`div`)]),a(`span`,{class:`token punctuation`},`>`)])]),e(`
`),a(`span`,{class:`line`},[a(`span`,{class:`token tag`},[a(`span`,{class:`token tag`},[a(`span`,{class:`token punctuation`},`</`),e(`template`)]),a(`span`,{class:`token punctuation`},`>`)])]),e(`
`),a(`span`,{class:`line`},[a(`span`,{class:`token tag`},[a(`span`,{class:`token tag`},[a(`span`,{class:`token punctuation`},`<`),e(`script`)]),a(`span`,{class:`token punctuation`},`>`)]),a(`span`,{class:`token script`},[a(`span`,{class:`token language-javascript`}),e(`
`),a(`span`,{class:`line`},[a(`span`,{class:`token keyword`},`export`),e(),a(`span`,{class:`token keyword`},`default`),e(),a(`span`,{class:`token punctuation`},`{`)]),e(`
`),a(`span`,{class:`line`},[e(`  `),a(`span`,{class:`token function-variable function`},`data`),a(`span`,{class:`token operator`},`:`),e(),a(`span`,{class:`token punctuation`},`(`),a(`span`,{class:`token punctuation`},`)`),e(),a(`span`,{class:`token operator`},`=>`),e(),a(`span`,{class:`token punctuation`},`(`),a(`span`,{class:`token punctuation`},`{`),e(),a(`span`,{class:`token literal-property property`},`msg`),a(`span`,{class:`token operator`},`:`),a(`span`,{class:`token string`},`'hello world'`),e(),a(`span`,{class:`token punctuation`},`}`),a(`span`,{class:`token punctuation`},`)`),a(`span`,{class:`token punctuation`},`,`)]),e(`
`),a(`span`,{class:`line`},`  `),e(`
`),a(`span`,{class:`line`},[a(`span`,{class:`token punctuation`},`}`),a(`span`,{class:`token punctuation`},`;`)]),e(`
`),a(`span`,{class:`line`})]),a(`span`,{class:`token tag`},[a(`span`,{class:`token tag`},[a(`span`,{class:`token punctuation`},`</`),e(`script`)]),a(`span`,{class:`token punctuation`},`>`)])]),e(`
`),a(`span`,{class:`line`},[a(`span`,{class:`token tag`},[a(`span`,{class:`token tag`},[a(`span`,{class:`token punctuation`},`<`),e(`style`)]),a(`span`,{class:`token punctuation`},`>`)]),a(`span`,{class:`token style`},[a(`span`,{class:`token language-css`}),e(`
`),a(`span`,{class:`line`},[a(`span`,{class:`token selector`},`.box span`),e(),a(`span`,{class:`token punctuation`},`{`)]),e(`
`),a(`span`,{class:`line`},[e(`  `),a(`span`,{class:`token property`},`color`),a(`span`,{class:`token punctuation`},`:`),e(` red`),a(`span`,{class:`token punctuation`},`;`)]),e(`
`),a(`span`,{class:`line`},[a(`span`,{class:`token punctuation`},`}`)]),e(`
`),a(`span`,{class:`line`})]),a(`span`,{class:`token tag`},[a(`span`,{class:`token tag`},[a(`span`,{class:`token punctuation`},`</`),e(`style`)]),a(`span`,{class:`token punctuation`},`>`)])]),e(`
`),a(`span`,{class:`line`},` `),e(`
`),a(`span`,{class:`line`})])]),a(`div`,{class:`line-numbers`,"aria-hidden":`true`,style:{"counter-reset":`line-number 0`}},[a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`}),a(`div`,{class:`line-number`})])],-1)]]),_:1}),u[5]||=r(`<h3 id="vue实例" tabindex="-1"><a class="header-anchor" href="#vue实例"><span>Vue实例</span></a></h3><ul><li>注意 1：<strong>先在data中声明数据，再使用数据</strong></li><li>注意 2：可以通过 <code>vm.$data</code> 访问到data中的所有属性，或者 <code>vm.msg</code></li></ul><div class="language-javascript" data-highlighter="prismjs" data-ext="js"><pre><code class="language-javascript"><span class="line"><span class="token keyword">let</span> vm <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Vue</span><span class="token punctuation">(</span><span class="token punctuation">{</span></span>
...
<span class="line">  }</span>
<span class="line">})</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="计算属性" tabindex="-1"><a class="header-anchor" href="#计算属性"><span>计算属性</span></a></h2>`,72),a(`ul`,null,[u[1]||=a(`li`,null,`说明：计算属性是基于它们的依赖进行缓存的，只有在它的依赖发生改变时才会重新求值`,-1),a(`li`,null,`注意：Mustache语法（`+n()+`）中不要放入太多的逻辑，否则会让模板过重、难以理解和维护`,1),u[2]||=a(`li`,null,[e(`注意：`),a(`strong`,null,`computed中的属性不能与data中的属性同名，否则会报错`)],-1),u[3]||=a(`li`,null,[a(`a`,{href:`http://www.cnblogs.com/kidney/p/7384835.html?utm_source=debugrun&utm_medium=referral`,target:`_blank`,rel:`noopener noreferrer`},`Vue computed属性原理`)],-1)]),u[6]||=r(`<div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">let vm = new Vue({</span>
...
<span class="line">    <span class="token keyword">return</span> Promise<span class="token punctuation">.</span><span class="token function">reject</span><span class="token punctuation">(</span>error<span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line">  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,147)])}var p=l(d,[[`render`,f]]);export{u as _pageData,p as default};