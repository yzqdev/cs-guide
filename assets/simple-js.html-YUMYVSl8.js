import{_ as s,c as n,a as e,o as p}from"./app-BKQjDlOh.js";const i={};function l(c,a){return p(),n("div",null,[...a[0]||(a[0]=[e(`<h1 id="javascript-开发人员需要知道的简写技巧" tabindex="-1"><a class="header-anchor" href="#javascript-开发人员需要知道的简写技巧"><span>JavaScript 开发人员需要知道的简写技巧</span></a></h1><h2 id="初级篇" tabindex="-1"><a class="header-anchor" href="#初级篇"><span>初级篇</span></a></h2><h3 id="_1、三目运算符" tabindex="-1"><a class="header-anchor" href="#_1、三目运算符"><span>1、三目运算符</span></a></h3><p>下面是一个很好的例子，将一个完整的 if 语句，简写为一行代码。</p><div class="language-javascript" data-highlighter="prismjs" data-ext="js"><pre><code class="language-javascript"><span class="line"><span class="token keyword">const</span> x <span class="token operator">=</span> <span class="token number">20</span><span class="token punctuation">;</span></span>
