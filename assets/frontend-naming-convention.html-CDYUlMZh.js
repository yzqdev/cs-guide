import{_ as n,c as a,a as e,o as l}from"./app-Die-Lcms.js";const i={};function t(p,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="前端开发规范-命名规范、html规范、css规范、js规范" tabindex="-1"><a class="header-anchor" href="#前端开发规范-命名规范、html规范、css规范、js规范"><span>前端开发规范：命名规范、html规范、css规范、js规范</span></a></h1><p>ps:资料来自网络 一个好的程序员肯定是要能书写可维护的代码，而不是一次性的代码，怎么能让团队当中其他人甚至一段时间时候你再看你某个时候写的代码也能看懂呢，这就需要规范你的代码了。 我是有一点强迫症的人，上周我们后端给我了一个CanUsename的接口（该接口的目的是判断输入的目的地是否是4级目的地），我真的是崩溃的。 我只是觉得这个名字不够语义化，但是让我自己想一个名字我又想不出来，于是我就在想，如果有一套命名规范的话，那么以后起名字就不用发愁了，直接按照规范来就好了~ 于是端午在家就百度了一下~</p><h1 id="命名" tabindex="-1"><a class="header-anchor" href="#命名"><span>命名</span></a></h1><h2 id="驼峰式命名法介绍" tabindex="-1"><a class="header-anchor" href="#驼峰式命名法介绍"><span>驼峰式命名法介绍</span></a></h2><ul><li><p>Pascal Case 大驼峰式命名法：首字母大写。eg：StudentInfo、UserInfo、ProductInfo</p></li><li><p>Camel Case 小驼峰式命名法：首字母小写。eg：studentInfo、userInfo、productInfo</p></li></ul><h2 id="文件资源命名" tabindex="-1"><a class="header-anchor" href="#文件资源命名"><span>文件资源命名</span></a></h2><ul><li><p>文件名不得含有空格</p></li><li><p>文件名建议只使用小写字母，不使用大写字母。( 为了醒目，某些说明文件的文件名，可以使用大写字母，比如README、LICENSE。 )</p></li><li><p>文件名包含多个单词时，单词之间建议使用半角的连词线 ( - ) 分隔。</p></li><li><p>引入资源使用相对路径，不要指定资源所带的具体协议 ( <code>http:</code>,<code>https:</code> ) ，除非这两者协议都不可用。</p></li></ul><p>不推荐：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">&lt;script src=&quot;http://cdn.com/foundation.min.js&quot;&gt;&lt;/script&gt;</span>
<span class="line"></span></code></pre></div><p>推荐</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">&lt;script src=&quot;//cdn.com/foundation.min.js&quot;&gt;&lt;/script&gt;</span>
<span class="line"></span></code></pre></div><h2 id="变量命名" tabindex="-1"><a class="header-anchor" href="#变量命名"><span>变量命名</span></a></h2><p><strong>命名方式</strong> : 小驼峰式命名方法 <strong>命名规范</strong> : 类型+对象描述的方式，如果没有明确的类型，就可以使前缀为名词</p><table><thead><tr><th style="text-align:left;">类型</th><th style="text-align:left;">小写字母</th></tr></thead><tbody><tr><td style="text-align:left;">array</td><td style="text-align:left;">a</td></tr><tr><td style="text-align:left;">boolean</td><td style="text-align:left;">b</td></tr><tr><td style="text-align:left;">function</td><td style="text-align:left;">fn</td></tr><tr><td style="text-align:left;">int</td><td style="text-align:left;">i</td></tr><tr><td style="text-align:left;">object</td><td style="text-align:left;">o</td></tr><tr><td style="text-align:left;">regular</td><td style="text-align:left;">r</td></tr><tr><td style="text-align:left;">string</td><td style="text-align:left;">s</td></tr></tbody></table><p>推荐</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">let tableTitle = &quot;LoginTable&quot;</span>
<span class="line"></span></code></pre></div><p>不推荐</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">let getTitle = &quot;LoginTable&quot;</span>
<span class="line"></span></code></pre></div><h2 id="函数" tabindex="-1"><a class="header-anchor" href="#函数"><span>函数</span></a></h2><p><strong>命名方式</strong> : 小驼峰方式 ( 构造函数使用大驼峰命名法 ) <strong>命名规则</strong> : 前缀为动词</p><table><thead><tr><th>动词</th><th>含义</th><th>返回值</th></tr></thead><tbody><tr><td>can</td><td>判断是否可执行某个动作 ( 权限 )</td><td>函数返回一个布尔值。true：可执行；false：不可执行</td></tr><tr><td>has</td><td>判断是否含有某个值</td><td>函数返回一个布尔值。true：含有此值；false：不含有此值</td></tr><tr><td>is</td><td>判断是否为某个值</td><td>函数返回一个布尔值。true：为某个值；false：不为某个值</td></tr><tr><td>get</td><td>获取某个值</td><td>函数返回一个非布尔值</td></tr><tr><td>set</td><td>设置某个值</td><td>无返回值、返回是否设置成功或者返回链式对象</td></tr></tbody></table><p>推荐：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">//是否可阅读</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre></div><h2 id="常量" tabindex="-1"><a class="header-anchor" href="#常量"><span>常量</span></a></h2><p><strong>命名方法</strong> : 全部大写 <strong>命名规范</strong> : 使用大写字母和下划线来组合命名，下划线用以分割单词。 推荐：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line"> let MAX_COUNT = 10;</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="注释规范" tabindex="-1"><a class="header-anchor" href="#注释规范"><span>注释规范</span></a></h2><h3 id="单行注释" tabindex="-1"><a class="header-anchor" href="#单行注释"><span>单行注释 ( // )</span></a></h3><ul><li>单独一行：//(双斜线)与注释文字之间保留一个空格</li><li>在代码后面添加注释：//(双斜线)与代码之间保留一个空格，并且//(双斜线)与注释文字之间保留一个空格。</li><li>注释代码：//(双斜线)与代码之间保留一个空格。</li></ul><p>推荐 :</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">// 调用了一个函数；1)单独在一行</span>
<span class="line">setTitle();</span>
<span class="line"></span>
<span class="line">let maxCount = 10; // 设置最大量；2)在代码后面注释</span>
<span class="line"></span>
<span class="line">// setName(); // 3)注释代码</span>
<span class="line"></span></code></pre></div><h2 id="多行注释-注释说明" tabindex="-1"><a class="header-anchor" href="#多行注释-注释说明"><span>多行注释 ( /<em>注释说明</em>/ )</span></a></h2><ul><li><p>若开始(/<code>*</code>和结束(<code>*</code>/)都在一行，推荐采用单行注释</p></li><li><p>若至少三行注释时，第一行为/</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">*</span>
<span class="line"></span></code></pre></div><p>，最后行为</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">*</span>
<span class="line"></span></code></pre></div><p>/，其他行以</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">*</span>
<span class="line"></span></code></pre></div><p>开始，并且注释文字与</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">*</span>
<span class="line"></span></code></pre></div><p>保留一个空格。</p><p>推荐 :</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">/*</span>
<span class="line">* 代码执行到这里后会调用setTitle()函数</span>
<span class="line">* setTitle()：设置title的值</span>
<span class="line">*/</span>
<span class="line">setTitle();</span>
<span class="line"></span></code></pre></div></li></ul><h2 id="函数-方法-注释" tabindex="-1"><a class="header-anchor" href="#函数-方法-注释"><span>函数 ( 方法 ) 注释</span></a></h2><p>函数(方法)注释也是多行注释的一种，但是包含了特殊的注释要求，参照 <a href="https://link.juejin.im/?target=http%3A%2F%2Fbaike.baidu.com%2Fitem%2Fjavadoc" target="_blank" rel="noopener noreferrer">javadoc(百度百科)</a> 语法：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">/** </span>
...
<span class="line"></span></code></pre></div><p>只兼容现代浏览器推荐:</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">&lt;html&gt;</span>
<span class="line">  &lt;head&gt;</span>
<span class="line">    &lt;link rel=&quot;stylesheet&quot; href=&quot;main.css&quot;&gt;</span>
<span class="line">    &lt;script src=&quot;main.js&quot; async&gt;&lt;/script&gt;</span>
<span class="line">  &lt;/head&gt;</span>
...
<span class="line">  &lt;/body&gt;</span>
<span class="line">&lt;/html&gt;</span>
<span class="line"></span></code></pre></div><h2 id="语义化" tabindex="-1"><a class="header-anchor" href="#语义化"><span>语义化</span></a></h2><p>我们一直都在说语义化编程，语义化编程，但是在代码中很少有人完全使用正确的元素。使用语义化标签也是有理由SEO的。</p><blockquote><p>语义化是指：根据元素其被创造出来时的初始意义来使用它。 意思就是用正确的标签干正确的事，而不是只有<code>div</code>和<code>span</code>。</p></blockquote><p>不推荐：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">&lt;b&gt;My page title&lt;/b&gt;</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre></div><p>推荐</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">html 代码:</span>
...
<span class="line">  background-color: red;</span>
<span class="line">}</span>
<span class="line"></span></code></pre></div><p><strong>图片和 SVG 图形能被引入到 HTML 中的唯一理由是它们呈现出了与内容相关的一些信息。</strong></p><p>不推荐</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">html 代码:</span>
...
<span class="line">  See the square next to me?</span>
<span class="line">&lt;/span&gt;</span>
<span class="line"></span></code></pre></div><p>推荐</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">html 代码:</span>
<span class="line">&lt;!-- That&#39;s clean markup! --&gt;</span>
<span class="line">&lt;span class=&quot;text-box&quot;&gt;</span>
<span class="line">  See the square next to me?</span>
<span class="line">&lt;/span&gt;</span>
...
<span class="line"></span></code></pre></div><p>推荐</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">// We declare a IIFE and pass parameters into the function that we will use from the global space</span>
...
<span class="line"></span></code></pre></div><p>推荐的IIFE写法:</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">(function(){</span>
<span class="line">  &#39;use strict&#39;;</span>
<span class="line"></span>
<span class="line">  // Code goes here</span>
<span class="line"></span>
<span class="line">}());</span>
<span class="line"></span></code></pre></div><p>如果你想引用全局变量或者是外层 IIFE 的变量，可以通过下列方式传参：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">(function($, w, d){</span>
<span class="line">  &#39;use strict&#39;;</span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h2 id="严格模式" tabindex="-1"><a class="header-anchor" href="#严格模式"><span>严格模式</span></a></h2><p>ECMAScript 5 严格模式可在整个脚本或独个方法内被激活。它对应不同的 javascript 语境会做更加严格的错误检查。严格模式也确保了 javascript 代码更加的健壮，运行的也更加快速。</p><p>严格模式会阻止使用在未来很可能被引入的预留关键字。</p><p>你应该在你的脚本中启用严格模式，最好是在独立的 IIFE 中应用它。避免在你的脚本第一行使用它而导致你的所有脚本都启动了严格模式，这有可能会引发一些第三方类库的问题。</p><h2 id="变量声明" tabindex="-1"><a class="header-anchor" href="#变量声明"><span>变量声明</span></a></h2><p>总是使用 let 来声明变量。如不指定 var，变量将被隐式地声明为全局变量，例如</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">let a = b = 0; //b会被隐式的创建为全局变量</span>
<span class="line"></span></code></pre></div><p>所以，请总是使用 let 来声明变量，并且使用单var模式（将所有的变量在函数最前面只使用一个var定义）。例如：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">(function (){</span>
<span class="line">  &#39;use strict&#39;</span>
...
<span class="line">}())</span>
<span class="line"></span></code></pre></div><p>采用严格模式带来的好处是，当你手误输入错误的变量名时，它可以通过报错信息来帮助你定位错误出处。</p><h2 id="js声明提前" tabindex="-1"><a class="header-anchor" href="#js声明提前"><span>js声明提前</span></a></h2><p>javascript会自动将函数作用域内的变量和方法的定义提前（只是提前声明，赋值还是在原处） 例如：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">(function(log){</span>
<span class="line">  &#39;use strict&#39;;</span>
<span class="line"></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>总结一下==</p><ul><li>false 除了和自身比较为 true 外，和 0，&quot;&quot; 比较也为 true</li><li>null 只和 undefined 比较时为 true， 反过来 undefined 也仅和 null 比较为 true，没有第二个</li><li>0 除了和 false 比较为 true，还有空字符串 &#39;&#39;&quot; 和空数组 []</li><li>空字符串 &#39;&#39; 除了和 false 比较为 true，还有一个数字 0</li></ul><blockquote><p>==, &gt;, &lt;, +, -, ... 这些操作符所造成的隐式类型转换都是无副作用的，它不会改变变量本身保存的值。，但是，如果你覆写某个对象的 <code>valueOf/toString</code>的话，==就会产生副作用.</p></blockquote><p>例如：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">Array.prototype.valueOf = function() {</span>
...
<span class="line">  }</span>
<span class="line">}</span>
<span class="line"></span></code></pre></div><p>等同于：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line"> x = x || y || 1;</span>
<span class="line"></span></code></pre></div><p>这一小技巧经常用来给方法设定默认的参数。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">(function(log){</span>
<span class="line">  &#39;use strict&#39;;</span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line">}(window.console.log));</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>推荐(函数式编程)：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">(function(log){</span>
<span class="line">  &#39;use strict&#39;;</span>
<span class="line"></span>
<span class="line">  let arr = [10, 3, 7, 9, 100, 20];</span>
<span class="line"></span>
...
<span class="line">}</span>
<span class="line"></span></code></pre></div><p>推荐 :</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">.heavy {</span>
<span class="line">  font-weight: 800;</span>
<span class="line">}</span>
<span class="line"></span>
...
<span class="line">  color: red;</span>
<span class="line">}</span>
<span class="line"></span></code></pre></div><h2 id="合理的使用id" tabindex="-1"><a class="header-anchor" href="#合理的使用id"><span>合理的使用ID</span></a></h2><p>一般情况下ID不应该被用于样式，并且ID的权重很高，所以不使用ID解决样式的问题，而是使用class 不推荐：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">#content .title {</span>
<span class="line">  font-size: 2em;</span>
<span class="line">}</span>
<span class="line"></span></code></pre></div><p>推荐：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">.content .title {</span>
<span class="line">  font-size: 2em;</span>
<span class="line">}</span>
<span class="line"></span></code></pre></div><h2 id="css选择器中避免使用标签名" tabindex="-1"><a class="header-anchor" href="#css选择器中避免使用标签名"><span>css选择器中避免使用标签名</span></a></h2><p>从结构、表现、行为分离的原则来看，应该尽量避免css中出现HTML标签，并且在css选择器中出现标签名会存在潜在的问题。</p><h2 id="使用子选择器" tabindex="-1"><a class="header-anchor" href="#使用子选择器"><span>使用子选择器</span></a></h2><p>很多前端开发人员写选择器链的时候不使用 直接子选择器（注：直接子选择器和后代选择器的区别）。 有时，这可能会导致疼痛的设计问题并且有时候可能会很耗性能。 然而，在任何情况下，这是一个非常不好的做法。 如果你不写很通用的，需要匹配到DOM末端的选择器， 你应该总是考虑直接子选择器。 不推荐:</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">.content .title {</span>
<span class="line">  font-size: 2rem;</span>
<span class="line">}</span>
<span class="line"></span></code></pre></div><p>推荐</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">.content &gt; .title {</span>
<span class="line">  font-size: 2rem;</span>
<span class="line">}</span>
<span class="line"></span></code></pre></div><h2 id="尽量使用缩写属性" tabindex="-1"><a class="header-anchor" href="#尽量使用缩写属性"><span>尽量使用缩写属性</span></a></h2><p>尽量使用缩写属性对于代码效率和可读性是很有用的，比如font属性。 不推荐：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">border-top-style: none;</span>
...
<span class="line"></span></code></pre></div><p>推荐：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">border-top: 0;</span>
<span class="line">font: 100%/1.6 palatino, georgia, serif;</span>
<span class="line">padding: 0 1em 2em;</span>
<span class="line"></span></code></pre></div><h2 id="_0后面不带单位" tabindex="-1"><a class="header-anchor" href="#_0后面不带单位"><span>0后面不带单位</span></a></h2><p>省略0后面的单位， 不推荐：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">padding-bottom: 0px;</span>
<span class="line">margin: 0em;</span>
<span class="line"></span></code></pre></div><p>推荐：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">padding-bottom: 0;</span>
<span class="line">margin: 0;</span>
<span class="line"></span></code></pre></div><h2 id="属性格式" tabindex="-1"><a class="header-anchor" href="#属性格式"><span>属性格式</span></a></h2><ul><li>为了保证一致性和可扩展性，每个声明应该用分号结束，每个声明换行。</li><li>属性名的冒号后使用一个空格。出于一致性的原因， 属性和值（但属性和冒号之间没有空格）的之间始终使用一个空格。</li><li>每个选择器和属性声明总是使用新的一行。</li><li>属性选择器或属性值用双引号（””），而不是单引号（”）括起来。</li><li>URI值（url()）不要使用引号。</li></ul><p>作为最佳实践，我们应该遵循以下顺序（应该按照下表的顺序）：</p><p>结构性属性：</p><ol><li>display</li><li>position, left, top, right etc.</li><li>overflow, float, clear etc.</li><li>margin, padding</li></ol><p>表现性属性：</p><ul><li>background, border etc.</li><li>font, text</li></ul><p>不推荐：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line"> .box {</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre></div><p>推荐：</p><div class="language-text" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">.box {</span>
