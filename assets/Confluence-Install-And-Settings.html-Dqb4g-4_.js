import{_ as e,c as n,o as t,d as l}from"./app-CbULZrmi.js";const o={},a=l(`<h1 id="confluence-安装和配置" tabindex="-1"><a class="header-anchor" href="#confluence-安装和配置"><span>Confluence 安装和配置</span></a></h1><h2 id="confluence-6-15-4" tabindex="-1"><a class="header-anchor" href="#confluence-6-15-4"><span>Confluence 6.15.4</span></a></h2><ul><li>最新 6.15.4 版本时间：2019-05</li></ul><h4 id="数据库" tabindex="-1"><a class="header-anchor" href="#数据库"><span>数据库</span></a></h4><pre><code>docker run \\
	...
	-d \\
	mysql:5.7
</code></pre><ul><li>连上容器：<code>docker exec -it mysql-confluence /bin/bash</code><ul><li>连上 MySQL：<code>mysql -u root -p</code></li></ul></li><li>设置编码： <ul><li><strong>必须做这一步，不然配置过程会报错，confluence 的 DB 要求是 utf8，还不能是 utf8mb4</strong></li><li><strong>并且排序规则还必须是：utf8_bin</strong></li><li><strong>数据库必须使用&#39;READ-COMMITTED&#39;作为默认隔离级别</strong></li></ul></li></ul><pre><code>SET NAMES &#39;utf8&#39;;
alter database confluence_db character set utf8 collate utf8_bin;
SET GLOBAL tx_isolation=&#39;READ-COMMITTED&#39;;
</code></pre><h4 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h4><ul><li>下载：<a href="https://www.atlassian.com/software/confluence/download" target="_blank" rel="noopener noreferrer">https://www.atlassian.com/software/confluence/download</a><ul><li>选择：linux64 类型下载</li></ul></li><li>授权：<code>chmod +x atlassian-confluence-6.15.4-x64.bin</code></li></ul><pre><code>./atlassian-confluence-6.15.4-x64.bin
