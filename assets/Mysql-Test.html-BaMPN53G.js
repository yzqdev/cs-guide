...
</code></pre><h3 id="安装-1" tabindex="-1"><a class="header-anchor" href="#安装-1"><span>安装</span></a></h3><ul><li>先确定本机安装过 MySQL</li><li>并且安装过：<code>yum install mysql-devel</code></li></ul><pre><code>git clone https://github.com/Percona-Lab/tpcc-mysql
cd tpcc-mysql/src
make
...
</code></pre><h3 id="测试的几个表介绍" tabindex="-1"><a class="header-anchor" href="#测试的几个表介绍"><span>测试的几个表介绍</span></a></h3><pre><code>tpcc-mysql的业务逻辑及其相关的几个表作用如下：
...
商品：主要对应item表
仓库：主要对应warehouse表
</code></pre><h3 id="准备" tabindex="-1"><a class="header-anchor" href="#准备"><span>准备</span></a></h3><ul><li>测试阿里云 ECS 与 RDS 是否相通：</li><li>记得在 RDS 添加账号和给账号配置权限，包括：配置权限、数据权限（默认添加账号后都是没有开启的，还要自己手动开启）</li><li>还要添加内网 ECS 到 RDS 的白名单 IP 里面</li><li>或者在 RDS 上开启外网访问设置，但是也设置 IP 白名单（访问 ip.cn 查看自己的外网 IP 地址，比如：120.85.112.97）</li><li>RDS 的内网地址和外网地址不一样，要认真看。</li></ul><pre><code>ping rm-wz9v0vej02ys79jbj.mysql.rds.aliyuncs.com

mysql -h rm-wz9v0vej02ys79jbj.mysql.rds.aliyuncs.com -P 3306 -u myaccount -p

输入密码：Aa123456
</code></pre><pre><code>创库，名字为：TPCC：
...
</code></pre><h3 id="测试" tabindex="-1"><a class="header-anchor" href="#测试"><span>测试</span></a></h3><ul><li><p>数据库：阿里云 RDS-MySQL-5.7-2C4G</p></li><li><p>测试机：阿里云 ECS-4C4G-CentOS7.6</p></li><li><p>根据测试，不同的 ECS 测试机，不同的 RDS 测试结果有时候差距挺大的，这个很蛋疼。</p></li><li><p>需要注意的是 tpcc 默认会读取 /var/lib/mysql/mysql.sock 这个 socket 文件。因此，如果你的socket文件不在相应路径的话，可以做个软连接，或者通过TCP/IP的方式连接测试服务器</p></li><li><p>准备数据：</p></li></ul><pre><code>cd /opt/tpcc-mysql
...
select count(*) from warehouse;
    80
</code></pre><ul><li>开始测试：</li></ul><pre><code>
...
</code></pre><h3 id="报表" tabindex="-1"><a class="header-anchor" href="#报表"><span>报表</span></a></h3><pre><code>&lt;TpmC&gt;
188.000 TpmC
TpmC结果值(每分钟事务数，该值是第一次统计结果中的新订单事务数除以总耗时分钟数，例如本例中是：372/2=186)
tpmC值在国内外被广泛用于衡量计算机系统的事务处理能力
</code></pre><ul><li>RDS-2C4G-80个仓库结果：</li><li>CPU：100%，内存：34%，连接数：17%，IOPS：62%，磁盘空间：20G</li></ul><pre><code>1780, trx: 979, 95%: 1849.535, 99%: 2402.613, max_rt: 3401.947, 986|3248.772, 98|698.821, 103|4202.110, 101|4547.416
...
&lt;TpmC&gt;
                 5812.667 TpmC
</code></pre><ul><li>升级：RDS-4C8G-80个仓库结果</li><li>CPU：100%，内存：55%，连接数：10%，IOPS：20%，磁盘空间：25G</li></ul><pre><code>1780, trx: 2303, 95%: 796.121, 99%: 1099.640, max_rt: 1596.883, 2293|2249.288, 232|256.393, 230|1694.050, 235|2550.775
...
&lt;TpmC&gt;
                 13552.467 TpmC
</code></pre><ul><li>升级：RDS-8C16G-80个仓库结果</li><li>CPU：100%，内存：35%，连接数：5%，IOPS：18%，磁盘空间：30G</li></ul><pre><code>1780, trx: 4502, 95%: 398.131, 99%: 501.634, max_rt: 772.128, 4473|740.073, 446|183.361, 448|1042.264, 442|1302.569
...
&lt;TpmC&gt;
                 26791.934 TpmC
</code></pre><ul><li>升级：RDS-16C64G-80个仓库结果</li><li>CPU：100%，内存：18%，连接数：2%，IOPS：10%，磁盘空间：40G</li></ul><pre><code>1780, trx: 8413, 95%: 203.560, 99%: 279.322, max_rt: 451.010, 8414|441.849, 841|92.900, 839|583.340, 843|644.276
...
&lt;TpmC&gt;
                 51097.668 TpmC
</code></pre><ul><li>几轮下来，最终数据量：</li></ul><pre><code>select count(*) from customer;
    2400000
select count(*) from district;
    800    
select count(*) from history;
