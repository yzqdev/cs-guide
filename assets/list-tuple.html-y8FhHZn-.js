...
name.append(&#39;六点水&#39;)
print(name)
</code></pre><p>输出的结果：</p><p><img src="http://twowaterimage.oss-cn-beijing.aliyuncs.com/2019-08-31-092406.png" alt=""></p><h2 id="_5、怎么删除-list-列表-里面的元素" tabindex="-1"><a class="header-anchor" href="#_5、怎么删除-list-列表-里面的元素"><span>5、怎么删除 List（列表） 里面的元素</span></a></h2><p>那既然这样，肯定会有人中途退出的。</p><p>那么我们就需要在列表中，把他的名字去掉。</p><p>这时候使用 del 语句来删除列表的的元素</p><pre><code class="language-python">name = [&#39;一点水&#39;, &#39;两点水&#39;, &#39;三点水&#39;, &#39;四点水&#39;, &#39;五点水&#39;]
...
print(tuple1[1])
print(tuple2[0])
</code></pre><p>输出的结果：</p><p><img src="http://upload-images.jianshu.io/upload_images/2136918-edfb7c9ebc7d5ab0.png?imageMogr2/auto-orient/strip|imageView2/2/w/1240" alt="访问 tuple"></p><h2 id="_4、修改元组-tuple" tabindex="-1"><a class="header-anchor" href="#_4、修改元组-tuple"><span>4、修改元组 （tuple）</span></a></h2><p>可能看到这个小标题有人会疑问，上面不是花了一大段来说 tuple 是不可变的吗？</p><p>这里怎么又来修改 tuple （元组） 了。</p><p>那是因为元组中的元素值是不允许修改的，但我们可以对元组进行连接组合，还有通过修改其他列表的值从而影响 tuple 的值。</p><p>具体看下面的这个例子：</p><pre><code class="language-python">#-*-coding:utf-8-*-
list1=[123,456]
