...
</code></pre><p>进入<code>src</code>目录下，使用gcc编译器，将C语言代码编译为dll动态库</p><pre><code class="language-shell">gcc test.c -shared -o test.dll
</code></pre><p>编写<code>main.dart</code></p><pre><code class="language-dart">import  &#39;dart:ffi&#39;  as ffi;
...
</code></pre><h3 id="深入用法" tabindex="-1"><a class="header-anchor" href="#深入用法"><span>深入用法</span></a></h3><p>这里写一个稍微深入一点的示例，我们在C语言中写一个简单加密算法，然后使用dart调用C函数加密解密</p><p>编写<code>encrypt_test.c</code>，这里写一个最简单的异或加密算法，可以看到加密和解密实际上是一样的</p><pre><code class="language-c">#include &lt;string.h&gt;
...
</code></pre><p>编译为动态库</p><pre><code>gcc encrypt_test.c -shared -o encrypt_test.dll
</code></pre><p>编写<code>main.dart</code></p><pre><code class="language-dart">import &#39;dart:ffi&#39;;
import &#39;dart:io&#39; show Platform;
import &quot;dart:convert&quot;;
...
</code></pre><p>修改代码</p><pre><code class="language-dart">import &#39;dart:ffi&#39;;
import &#39;dart:io&#39; show Platform;
import &quot;dart:convert&quot;;
...
</code></pre><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结"><span>总结</span></a></h2><p><code>dart:ffi</code>包目前正处理开发中，暂时释放的只有基础功能，且使用<code>dart:ffi</code>包后，Dart代码不能进行<code>aot</code>编译，不过Dart开发了<code>ffi</code>接口后，极大的扩展了dart语言的能力边界，就如同的Java的Jni一样，如果<code>ffi</code>接口开发得足够好用，Dart就能像Python那样成为一门真正的胶水语言。</p><p>大家如果有兴趣进一步研究，可以查看<code>dart:ffi</code>包源码，目前该包总共才5个dart文件，源码很少，适合学习。</p><p>参考资料： <a href="https://github.com/dart-lang/sdk/tree/master/sdk/lib/ffi" target="_blank" rel="noopener noreferrer">dart:ffi 源码</a><a href="https://github.com/dart-lang/sdk/blob/master/samples/ffi/sqlite/docs/sqlite-tutorial.md" target="_blank" rel="noopener noreferrer">dart:ffi 官方示例</a></p>`,42),a=[i];function l(d,c){return e(),n("div",null,a)}const p=t(o,[["render",l],["__file","ffi.html.vue"]]),f=JSON.parse('{"path":"/flutter-tutor/dart/ffi.html","title":"Dart ffi使用","lang":"zh-CN","frontmatter":{"description":"Dart ffi使用 本篇博客研究Dart语言如何调用C语言代码混合编程，最后我们实现一个简单示例，在C语言中编写简单加解密函数，使用dart调用并传入字符串，返回加密结果，调用解密函数，恢复字符串内容。 随着Dart SDK版本迭代，本文章部分内容已过时，最新版本教程已经上传B站，请查看 Dart FFI 入门 环境准备 编译器环境 如未安装过VS编...","head":[["meta",{"property":"og:url","content":"https://yzqdev.github.io/cs-guide/cs-guide/flutter-tutor/dart/ffi.html"}],["meta",{"property":"og:site_name","content":"cs-guide"}],["meta",{"property":"og:title","content":"Dart ffi使用"}],["meta",{"property":"og:description","content":"Dart ffi使用 本篇博客研究Dart语言如何调用C语言代码混合编程，最后我们实现一个简单示例，在C语言中编写简单加解密函数，使用dart调用并传入字符串，返回加密结果，调用解密函数，恢复字符串内容。 随着Dart SDK版本迭代，本文章部分内容已过时，最新版本教程已经上传B站，请查看 Dart FFI 入门 环境准备 编译器环境 如未安装过VS编..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2023-06-25T05:00:38.000Z"}],["meta",{"property":"article:author","content":"yzqdev"}],["meta",{"property":"article:modified_time","content":"2023-06-25T05:00:38.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Dart ffi使用\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2023-06-25T05:00:38.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yzqdev\\",\\"url\\":\\"http://www.yzqdev.top\\"}]}"]]},"headers":[{"level":2,"title":"环境准备","slug":"环境准备","link":"#环境准备","children":[{"level":3,"title":"编译器环境","slug":"编译器环境","link":"#编译器环境","children":[]},{"level":3,"title":"Dart SDK环境","slug":"dart-sdk环境","link":"#dart-sdk环境","children":[]}]},{"level":2,"title":"测试Dart ffi接口","slug":"测试dart-ffi接口","link":"#测试dart-ffi接口","children":[{"level":3,"title":"简单示例","slug":"简单示例","link":"#简单示例","children":[]},{"level":3,"title":"深入用法","slug":"深入用法","link":"#深入用法","children":[{"level":4,"title":"完善代码","slug":"完善代码","link":"#完善代码","children":[]}]}]},{"level":2,"title":"总结","slug":"总结","link":"#总结","children":[]}],"git":{"createdTime":1684738995000,"updatedTime":1687669238000,"contributors":[{"name":"yzqdev","email":"yzqdev@outlook.com","commits":1}]},"readingTime":{"minutes":6.38,"words":1913},"filePathRelative":"flutter-tutor/dart/ffi.md","localizedDate":"2023年5月22日","autoDesc":true}');export{p as comp,f as data};
