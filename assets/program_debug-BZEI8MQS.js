import{i as e,r as t,s as n,t as r}from"./app-Bmf6MlmU.js";var i=JSON.parse(`{"path":"/linux-tutor/common/program_debug.html","title":"程序调试","lang":"zh-CN","frontmatter":{"description":"程序调试 进程调试 gdb 程序交互调试 GDB是一个由GNU开源组织发布的、UNIX/LINUX操作系统下的、基于命令行的、功能强大的程序调试工具。 对于一名Linux下工作的c++程序员，gdb是必不可少的工具； GDB中的命令固然很多，但我们只需掌握其中十个左右的命令，就大致可以完成日常的基本的程序调试工作。 以下从一个完整的调试过程简单说明最基...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"程序调试\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-07-15T12:37:10.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yzqdev\\",\\"url\\":\\"http://www.yzqdev.top\\"}]}"],["meta",{"property":"og:url","content":"https://yzqdev.github.io/cs-guide/cs-guide/linux-tutor/common/program_debug.html"}],["meta",{"property":"og:site_name","content":"cs-guide"}],["meta",{"property":"og:title","content":"程序调试"}],["meta",{"property":"og:description","content":"程序调试 进程调试 gdb 程序交互调试 GDB是一个由GNU开源组织发布的、UNIX/LINUX操作系统下的、基于命令行的、功能强大的程序调试工具。 对于一名Linux下工作的c++程序员，gdb是必不可少的工具； GDB中的命令固然很多，但我们只需掌握其中十个左右的命令，就大致可以完成日常的基本的程序调试工作。 以下从一个完整的调试过程简单说明最基..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-07-15T12:37:10.000Z"}],["meta",{"property":"article:modified_time","content":"2026-07-15T12:37:10.000Z"}]]},"git":{"createdTime":1653565176000,"updatedTime":1784119030000,"contributors":[{"name":"yzqdev","username":"yzqdev","email":"yzqdev@outlook.com","commits":4,"url":"https://github.com/yzqdev"}]},"readingTime":{"minutes":10.68,"words":3205},"filePathRelative":"linux-tutor/common/program_debug.md","autoDesc":true}`),a={name:`program_debug.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="程序调试" tabindex="-1"><a class="header-anchor" href="#程序调试"><span>程序调试</span></a></h1><h2 id="进程调试" tabindex="-1"><a class="header-anchor" href="#进程调试"><span>进程调试</span></a></h2><h3 id="gdb-程序交互调试" tabindex="-1"><a class="header-anchor" href="#gdb-程序交互调试"><span>gdb 程序交互调试</span></a></h3><p>GDB是一个由GNU开源组织发布的、UNIX/LINUX操作系统下的、基于命令行的、功能强大的程序调试工具。</p><p>对于一名Linux下工作的c++程序员，gdb是必不可少的工具；</p><p>GDB中的命令固然很多，但我们只需掌握其中十个左右的命令，就大致可以完成日常的基本的程序调试工作。</p><p>以下从一个完整的调试过程简单说明最基本的几个命令;</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">    <span class="token variable">$gdb</span> programmer     <span class="token comment"># 启动gdb</span></span>
...
<span class="line"></span></code></pre></div><p>当你完成了第一个程序调试之后，你当然会需要更多的命令：关于gdb常用命令及各种调试方法详见 <code>gdb</code>{.interpreted-text role=&quot;ref&quot;} ;</p><p>同时，如需更高效的调试：常用的调试命令都会有单字符的缩写，使用缩写更方便；同时，直接敲回车表示重复执行上一步命令；这在单步调试时非常有用；</p><h3 id="pstack-跟踪栈空间" tabindex="-1"><a class="header-anchor" href="#pstack-跟踪栈空间"><span>pstack 跟踪栈空间</span></a></h3><p>pstack是一个脚本工具，可显示每个进程的栈跟踪。pstack 命令必须由相应进程的属主或 root 运行。其核心实现就是使用了gdb以及thread apply all bt命令;</p><p>语法:</p><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">    $pstack &lt;program-pid&gt;</span>
...
</code></pre><p>使用了-m和-u选项，用来查找所有正在使用redis-server的所有进程的PID以及该进程的OWNER；</p><p>fuser通常被用在诊断系统的&quot;resource busy&quot;问题。如果你希望kill所有正在使用某一指定的file, file system or sockets的进程的时候，可使用-k选项:</p><pre><code>$fuser –k /path/to/your/filename
...
0000100   ,   i   )   ;  \\n   }  \\n
0000107
</code></pre><p>注：类似命令还有hexdump（十六进制输出）</p>`,84)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};