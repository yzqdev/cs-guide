import{i as e,r as t,s as n,t as r}from"./app-Bmf6MlmU.js";var i=JSON.parse(`{"path":"/python-tutor/basics/14-style.html","title":"编码规范","lang":"zh-CN","frontmatter":{"order":14,"description":"编码规范 一、简明概述 1、编码 如无特殊情况，文件一律使用 UTF-8 编码。 如无特殊情况，文件头部必须加入 #-*-coding:utf-8-*- 标识。 2、代码格式 2.1、缩进 统一使用 4 个空格进行缩进。 2.2、行宽 每行代码尽量不超过 80 个字符（在特殊情况下可以略微超过 80，但最长不得超过 120）。 理由： 这在查看 sid...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"编码规范\\",\\"image\\":[\\"http://twowaterimage.oss-cn-beijing.aliyuncs.com/2019-07-20-Python%E4%BB%A3%E7%A0%81%E8%A7%84%E8%8C%83.png\\"],\\"dateModified\\":\\"2026-07-16T05:29:15.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"yzqdev\\",\\"url\\":\\"http://www.yzqdev.top\\"}]}"],["meta",{"property":"og:url","content":"https://yzqdev.github.io/cs-guide/cs-guide/python-tutor/basics/14-style.html"}],["meta",{"property":"og:site_name","content":"cs-guide"}],["meta",{"property":"og:title","content":"编码规范"}],["meta",{"property":"og:description","content":"编码规范 一、简明概述 1、编码 如无特殊情况，文件一律使用 UTF-8 编码。 如无特殊情况，文件头部必须加入 #-*-coding:utf-8-*- 标识。 2、代码格式 2.1、缩进 统一使用 4 个空格进行缩进。 2.2、行宽 每行代码尽量不超过 80 个字符（在特殊情况下可以略微超过 80，但最长不得超过 120）。 理由： 这在查看 sid..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"http://twowaterimage.oss-cn-beijing.aliyuncs.com/2019-07-20-Python%E4%BB%A3%E7%A0%81%E8%A7%84%E8%8C%83.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-07-16T05:29:15.000Z"}],["meta",{"property":"article:modified_time","content":"2026-07-16T05:29:15.000Z"}]]},"git":{"createdTime":1653497324000,"updatedTime":1784179755000,"contributors":[{"name":"yzqdev","username":"yzqdev","email":"yzqdev@outlook.com","commits":5,"url":"https://github.com/yzqdev"}]},"readingTime":{"minutes":6.74,"words":2021},"filePathRelative":"python-tutor/basics/14-style.md","autoDesc":true}`),a={name:`14-style.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="编码规范" tabindex="-1"><a class="header-anchor" href="#编码规范"><span>编码规范</span></a></h1><p><img src="http://twowaterimage.oss-cn-beijing.aliyuncs.com/2019-07-20-Python代码规范.png" alt=""></p><h1 id="一、简明概述" tabindex="-1"><a class="header-anchor" href="#一、简明概述"><span>一、简明概述</span></a></h1><h2 id="_1、编码" tabindex="-1"><a class="header-anchor" href="#_1、编码"><span>1、编码</span></a></h2><ul><li>如无特殊情况，文件一律使用 UTF-8 编码。</li><li>如无特殊情况，文件头部必须加入 <code>#-*-coding:utf-8-*-</code> 标识。</li></ul><h2 id="_2、代码格式" tabindex="-1"><a class="header-anchor" href="#_2、代码格式"><span>2、代码格式</span></a></h2><h3 id="_2-1、缩进" tabindex="-1"><a class="header-anchor" href="#_2-1、缩进"><span>2.1、缩进</span></a></h3><ul><li>统一使用 4 个空格进行缩进。</li></ul><h3 id="_2-2、行宽" tabindex="-1"><a class="header-anchor" href="#_2-2、行宽"><span>2.2、行宽</span></a></h3><p>每行代码尽量不超过 80 个字符（在特殊情况下可以略微超过 80，但最长不得超过 120）。</p><p>理由：</p><ul><li>这在查看 side-by-side 的 diff 时很有帮助。</li><li>方便在控制台下查看代码。</li><li>太长可能是设计有缺陷。</li></ul><h3 id="_2-3、引号" tabindex="-1"><a class="header-anchor" href="#_2-3、引号"><span>2.3、引号</span></a></h3><p>简单说，自然语言使用双引号，机器标示使用单引号，因此<strong>代码里</strong>多数应该使用<strong>单引号</strong>。</p><ul><li><strong>自然语言</strong> <strong>使用双引号</strong> <code>&quot;...&quot;</code>。例如错误信息；很多情况还是 unicode，使用 <code>u&quot;你好世界&quot;</code>。</li><li><strong>机器标识</strong> <strong>使用单引号</strong> <code>&#39;...&#39;</code>。例如 dict 里的 key。</li><li><strong>正则表达式</strong> <strong>使用原生的双引号</strong> <code>r&quot;...&quot;</code>。</li><li><strong>文档字符串 (docstring)</strong> <strong>使用三个双引号</strong> <code>&quot;&quot;&quot;......&quot;&quot;&quot;</code>。</li></ul><h3 id="_2-4、空行" tabindex="-1"><a class="header-anchor" href="#_2-4、空行"><span>2.4、空行</span></a></h3><ul><li>模块级函数和类定义之间空两行；</li><li>类成员函数之间空一行；</li></ul><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token keyword">class</span> <span class="token class-name">A</span><span class="token punctuation">:</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre></div>`,100)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};