...
<span class="line">	<span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre></div><ul><li>启动 Logstash 并加载该配置文件：<code>/usr/program/elk/logstash-2.4.1/bin/logstash -f /usr/program/elk/logstash-2.4.1/config/regexp-test.conf</code></li></ul><h3 id="nginx-日志收集" tabindex="-1"><a class="header-anchor" href="#nginx-日志收集"><span>Nginx 日志收集</span></a></h3>`,26),i(`ul`,null,[l[5]||=i(`li`,null,[e(`机子：192.168.1.121 `),i(`ul`,null,[i(`li`,null,[e(`Nginx 日志位置： `),i(`ul`,null,[i(`li`,null,[i(`code`,null,`/var/log/nginx/access.log`)]),i(`li`,null,[i(`code`,null,`/var/log/nginx/error.log`)])])])])],-1),i(`li`,null,[l[4]||=e(`安装 Logstash 过程请看：`,-1),a(m,{to:`/linux-tutor/linux-server/ELK-Install-And-Settings.html`},{default:r(()=>[...l[3]||=[e(`ELK 日志收集系统安装和配置`,-1)]]),_:1})]),l[6]||=i(`li`,null,[e(`新建目录（如果存在就不用）：`),i(`code`,null,`mkdir -p /usr/program/elk/logstash-2.4.1/config`)],-1),l[7]||=i(`li`,null,[i(`strong`,null,`新建`),e(` 配置文件：`),i(`code`,null,`vim /usr/program/elk/logstash-2.4.1/config/nginx.conf`),e(`：`)],-1)]),l[15]||=n(`<div class="language-nginx line-numbers-mode" data-highlighter="prismjs" data-ext="nginx"><pre><code class="language-nginx"><span class="line"><span class="token directive"><span class="token keyword">input</span></span> <span class="token punctuation">{</span></span>
<span class="line">	<span class="token directive"><span class="token keyword">file</span></span> <span class="token punctuation">{</span></span>
<span class="line">		path =&gt; [&quot;/var/log/nginx/access.log&quot;]</span>
<span class="line">		type =&gt; &quot;nginx-access-log&quot;</span>
<span class="line">		start_position =&gt; &quot;beginning&quot;</span>
...
<span class="line">	<span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>启动 Logstash 并加载该配置文件：<code>/usr/program/elk/logstash-2.4.1/bin/logstash -f /usr/program/elk/logstash-2.4.1/config/nginx.conf</code></li><li>然后你开始访问 nginx，再关注 elasticsearch 集群的索引变化，如果有新增索引那就表示可以了。</li></ul><h3 id="tomcat-日志收集" tabindex="-1"><a class="header-anchor" href="#tomcat-日志收集"><span>Tomcat 日志收集</span></a></h3>`,9),i(`ul`,null,[l[10]||=i(`li`,null,[e(`机子：192.168.1.121 `),i(`ul`,null,[i(`li`,null,[e(`Tomcat 日志位置：`),i(`code`,null,`/usr/program/tomcat8/logs`)])])],-1),i(`li`,null,[l[9]||=e(`安装 Logstash 过程请看：`,-1),a(m,{to:`/linux-tutor/linux-server/ELK-Install-And-Settings.html`},{default:r(()=>[...l[8]||=[e(`ELK 日志收集系统安装和配置`,-1)]]),_:1})]),l[11]||=i(`li`,null,[e(`新建目录（如果存在就不用）：`),i(`code`,null,`mkdir -p /usr/program/elk/logstash-2.4.1/config`)],-1),l[12]||=i(`li`,null,[i(`strong`,null,`新建`),e(` 配置文件：`),i(`code`,null,`vim /usr/program/elk/logstash-2.4.1/config/tomcat.conf`),e(`：`)],-1)]),l[16]||=n(`<div class="language-nginx line-numbers-mode" data-highlighter="prismjs" data-ext="nginx"><pre><code class="language-nginx"><span class="line"><span class="token directive"><span class="token keyword">input</span></span> <span class="token punctuation">{</span></span>
<span class="line">	<span class="token directive"><span class="token keyword">file</span></span> <span class="token punctuation">{</span></span>
<span class="line">		<span class="token directive"><span class="token keyword">path</span> =&gt; [<span class="token string">&quot;/usr/program/tomcat8/logs/logbackOutFile.log.*.log&quot;</span>]</span>
<span class="line">		type =&gt; <span class="token string">&quot;tomcat-log&quot;</span></span>
<span class="line">		start_position =&gt; <span class="token string">&quot;beginning&quot;</span></span>
...
<span class="line">	<span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考" tabindex="-1"><a class="header-anchor" href="#参考"><span>参考</span></a></h2><ul><li><a href="https://liang178.github.io/2016/08/11/elk+rabbitmq/" target="_blank" rel="noopener noreferrer">https://liang178.github.io/2016/08/11/elk+rabbitmq/</a></li></ul>`,24)])}var f=c(u,[[`render`,d]]);export{l as _pageData,f as default};