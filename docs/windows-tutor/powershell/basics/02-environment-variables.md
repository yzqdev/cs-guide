...
如果出现环境变量 path 的编辑一直是编辑文本的样式，则需要将 `%SystemRoot%\system32` 这个变量移到最前面，这样干就变成了列表的样式。

## 使用 PowerShell 编辑环境变量

查看微软官方文档：<https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_environment_variables?view=powershell-7.1>
...
# env 有如下变量: USERPROFILE, username, path, windir, COMPUTERNAME 等等
