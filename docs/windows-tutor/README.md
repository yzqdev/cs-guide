...
- [数组](./powershell/basics/array.md)
- [cmd和powershell的对比](./powershell/basics/cmd-to-powershell.md)
- [cmdlet](./powershell/basics/cmdlet.md)
- [复制](./powershell/basics/copy-item.md)
- [环境变量配置](./powershell/basics/environment-varibles.md)
- [哈希](./powershell/basics/hash.md)
- [别名alias](./powershell/basics/my-alias.md)
- [网络相关](./powershell/basics/network.md)
- [管道](./powershell/basics/pipline.md)
- [基础](./powershell/basics/README.md)
- [字符串](./powershell/basics/string.md)
- [变量](./powershell/basics/varibles.md)
- [web请求](./powershell/basics/web-request.md)
...
- [我的posh片段](./powershell/ps-snippets.md)
- [powershell教程](./powershell/README.md)

## rust-tutor

- [rust包管理](./rust-tutor/package-manage.md)
- [rust教程](./rust-tutor/README.md)
- [教程](./rust-tutor/tutor.md)

## soft-config

- [chrome配置](./soft-config/chrome.md)
- [软件配置文件](./soft-config/program-lang-confs.md)
- [软件配置](./soft-config/README.md)
- [配置文件路径](./soft-config/software-configs.md)
...
- [编码问题](./windows-tips/about-encode.md)
- [windows常用路径](./windows-tips/common-paths.md)
- [windows常用注册表](./windows-tips/common-regs.md)
- [windows技巧](./windows-tips/README.md)

## wsl2

- [wsl教程](./wsl2/README.md)
- [wsl配置](./wsl2/wsl-config.md)

## windows-tutor

- [好用的编程软件](./awesome-programming.md)
- [一些好用的网站](./awesome-sites.md)
