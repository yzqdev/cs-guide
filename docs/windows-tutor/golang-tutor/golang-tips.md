...
- 特殊格式
  ...
  - [toml](https://github.com/BurntSushi/toml) - TOML 配置格式 format (encoder/decoder with reflection).(弃用）
- 工具
...
- [abutil](https://github.com/bahlo/abutil) - 常用 Go 语言工具的集合（已弃用）
- [apm](https://github.com/topfreegames/apm) - Go 语言进程管理工具具有HTTP API （已弃用）
...
- [Goreq](https://github.com/franela/Goreq) - 简洁的 Go 语言 http 请求库（已弃用）
- [Goreq](https://github.com/smallnest/Goreq) - 更加简化的 http客户端，基于 Gorequest.（已弃用）
...
- [grequests](https://github.com/levigross/grequests) - 简单优雅的 `net/HTTP` 封装，紧随 Python 的 requests 的步伐 （已弃用）
...
- [Go Metrics](https://github.com/rcrowley/Go-metrics) - Coda Hale 的 Metrics library的 Go 语言接口: [https://github.com/codahale/metrics](https://github.com/codahale/metrics).
...
- [Gogland](https://www.jetbrains.com/go/) - 跨平台、全功能 Go 语言集成开发环境
