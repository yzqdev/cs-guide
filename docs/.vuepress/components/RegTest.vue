            ...
            <n-layout-header>
              <n-card style="margin-bottom: 20px">
                <n-space align="center">
                  ...
                  <n-button type="info" @click.stop="genCode"
                    >生成代码</n-button
                  >
                  <n-button
                      ...
                      <n-input-group>
                        ...
                        <n-popover placement="bottom" trigger="click">
                          <ul style="padding: 12px; min-width: 350px">
                            ...
                            <li class="dropdown-item">
                              <code><strong>[abc]</strong></code> - 匹配 a、b 或
                              c 中的一个字母。
                            </li>
                            <li class="dropdown-item">
                            ...
                            <li class="dropdown-item">
                              <code><strong>[^abc]</strong></code> - 匹配除了
                              a、b 或 c 中的其他字母。
                            </li>
                            <li class="dropdown-item">
                            ...
                            <li class="dropdown-item">
                              <code><strong>?</strong></code> - 0 次或 1
                              次匹配。
                            </li>

                            <li class="dropdown-item">
                              <code><strong>*</strong></code> - 匹配 0
                              次或多次。
                            </li>
                            <li class="dropdown-item">
                              <code><strong>+</strong></code> - 匹配 1
                              次或多次。
                            </li>
                            <li class="dropdown-item">
