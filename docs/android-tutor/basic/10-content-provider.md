...
## 示例
  ...
  本示例将向您说明如何创建自己的ContentProvider(内容提供者)。因此，可以按照以下步骤进行操作，类似于创建[Hello World 例子](https://www.jc2182.com/andriod/android-hello-world.html)时遵循的步骤-
...
现在启动内容提供者，可以单击“添加学生”按钮，这将保存一条记录到数据库，如下所示：
